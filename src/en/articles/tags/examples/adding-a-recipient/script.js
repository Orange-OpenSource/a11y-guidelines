...
function removeItem(item) {
  item.remove();
  speak(item.querySelector("button").textContent + " remove from recipients, " + document.getElementById("selection-list").children.length + " recipients selected");
}
...
function addItem(text) {
  ...
  button.setAttribute("aria-label","remove "+text+" from the list.");
  ...
  speak(text + " added to recipients, " + document.getElementById("selection-list").children.length + " recipients selected");
}
