    ...
    'en': [
      ...
      },
      {
        ...
        subLevels: [
          ...
          { label: '11 Essentials', href: '/en/web/must-haves-checklist/' }
        ]
      },
      {
        label: 'Android',
        ...
        subLevels: [
          ...
          { label: '11 Essentials', href: '/en/mobile/android/checklist/' }
        ]
      },
      {
        label: 'iOS',
      ...
      },
      {
        ...
        subLevels: [
          ...
          { label: '11 Essentials', href: '/en/content-and-communication/must-haves/' }
        ]
      },
    ...
    'fr': [
      ...
      },
      {
        ...
        subLevels: [
          ...
          { label: '11 Incontournables', href: '/fr/web/checklist-initiale/' }
        ]
      },
      {
        label: 'Android',
        ...
        subLevels: [
          ...
          { label: '11 Incontournables', href: '/fr/mobile/android/checklist/' }
        ]
      },
      {
        label: 'iOS',
        ...
        subLevels: [
          ...
          { label: '11 Incontournables', href: '/fr/mobile/ios/checklist/' },
      ...
      },
      {
        ...
        subLevels: [
          ...
          { label: '11 Incontournables', href: '/fr/contenu-et-communication/incontournables/' }
        ]
      },
