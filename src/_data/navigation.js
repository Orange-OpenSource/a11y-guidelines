    ...
    'en': [
      ...
      },
      {
        ...
        subLevels: [
          ...
          { label: '11 Essentials', href: '/en/mobile/android/essentials-checklist/' }
        ]
      },
      {
        label: 'iOS',
      ...
      },
      {
        ...
        subLevels: [
          ...
          { label: '11 Essentials', href: '/en/content-and-communication/essentials-checklist/' }
        ]
      },
    ...
    'fr': [
      ...
      },
      {
        ...
        subLevels: [
          ...
          { label: '11 Incontournables', href: '/fr/web/checklist-incontournables/' }
        ]
      },
      {
        label: 'Android',
        ...
        subLevels: [
          ...
          { label: '11 Incontournables', href: '/fr/mobile/android/checklist-incontournables/' }
        ]
      },
      {
        label: 'iOS',
        ...
        subLevels: [
          ...
          { label: '11 Incontournables', href: '/fr/mobile/ios/checklist-incontournables/' },
      ...
      },
      {
        ...
        subLevels: [
          ...
          { label: '11 Incontournables', href: '/fr/contenu-et-communication/checklist-incontournables/' }
        ]
      },
