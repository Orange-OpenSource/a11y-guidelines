module.exports = {
  ...
  mainNavigation: {
    'en': [
      { label: 'Home', href: '/en/' },
      { label: 'Web', href: '/en/web/' },
      { label: 'Android', href: '/en/mobile/android/' },
      { label: 'iOS', href: '/en/mobile/ios/' },
      { label: 'Editorial content', href: '/en/editorial-content/' },
    ...
    'fr': [
      ...
      { label: 'Contenu éditorial', href: '/fr/contenu-editorial/' },
