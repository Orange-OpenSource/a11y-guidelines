        ...
        let app = new function () {
            ...
            this.UpdateFeedback = function (activeFilter, nbTests, isRefresh) {
                ...
                if (activeFilter) {
                    ...
                    htmlFeedback = '<p><b>' + nbTests + '</b> ' + test + ' ' + translate('withCurrentFilters') + '<button type="button" class="btn btn-secondary btn-sm mt-2 mb-3" id="reinitLink">' + translate('reinitFilters') + '</a></p>';
