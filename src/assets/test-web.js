    ...
    let app = new function() {
      ...
      this.FetchAll = function(currentRefTests) {
        ...
        for (let i in currentRefTests) {
          ...
          htmlrefTests += '<article class="accordion-item"><div class="accordion-header" id="heading'+i+'"><h3 class="card-title mb-0"><button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapse'+i+'" aria-expanded="false" aria-controls="collapse'+i+'"><span class="accordion-title h6 mb-0 flex-grow-1">' + currentRefTests[i].title + '</span><span class="badge bg-light mr-2 align-self-center">'+((currentRefTests[i].profils[0] == 'Concepteur') ? translate('conception') : translate('development'))+'</span></a></h3>';
