document.addEventListener("DOMContentLoaded", function(event) {
  ...
  doXHR('/assets/json/checklist/tests-tv-'+lang+'.json', function(errFirst, responseFirst) {  
    if (errFirst) {
      reqError();
    }
    return doXHR('/assets/json/checklist/tests-concepteur-tv-'+lang+'.json', function(errSecond, responseSecond) {
      if (errSecond) {
        reqError();
      }
