---
title: "Critères incontournables sur TV"
abstract: "Notre socle de critères destiné aux applications TV"
displayToc: true
leftColumn:
  display: false
  components:
...
# Application TV - Liste des critères d'accessibilité incontournables

Ce socle de critères, destiné aux applications TV, permet d’éviter les principales erreurs d’accessibilité.
Sa mise en œuvre ne permet pas d’obtenir à coup sûr une application TV accessible, mais pose les fondations qui permettent de s’engager dans une démarche de mise en accessibilité progressive.
