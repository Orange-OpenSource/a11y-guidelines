...
Avec l'arrivée de l'EAA, je pensais que les salaires en a11y allaient s'améliorer, pas sûr pourtant on manque de professionnels, voici upn moyen de comparer (en) https://webaim.org/projects/salary/. Une réflexion sur le métier d'expert a11y (_https://blog.hello-bokeh.fr/2025/01/07/accessibility-operations-reflexions-sur-le-metier/) suite à la lecture de The Accessibility Operations Guidebook de Devon Persing qui fait écho à mes préoccupations, ça donne envie d&e le lire...
...
- Le rapport de la France pour le WAD (Web Accessibility Directive) : https://ec.europa.eu/newsroom/dae/redirection/document/113780, (en) https://ec.europa.eu/newsroom/dae/redirection/document/113781
...
- Automatisable ou pas pour tous les critères WCAG, mise au poing (en) : https://html5accessibility.com/stuff/2025/03/27/mind-the-wcag-automation-gap/
...
- Tester WCAG 2.5.2 pointer cancellation avec un bookmarklet : https://www.temesis.com/blog/pointer-cancellation-inspector-un-outil-pour-verifier-l-application-de-wcag-2-5-2-rgaa-13-11/
...
- Un bookmarklet pour tester WCAG SC 1.3.5: Identify Input Purpose, bien pratique  :https://github.com/MewenLeHo/detectAutocomplete/tree/main>

## Points techniques

- Problème en cascade lors d'un reflow en responsive, quelques pistes (en)  :https://adrianroselli.com/2025/02/1-4-10-adversarial-conformance.html
...
- État des lieux de l'accessibilité des apps mobile App en 2025, retour sur une des présentations du axe-con 2025 (en) : https://youtu.be/RCVIOPTx7GM
...
- Abra Academy propose un cours en ligne de 45min sur l'accessibilité iOS et Android, simple et efficace pour s'approprier le sujet (en) : https://academy.abra.ai/courses/kick-off
...
- Tutoriels pour créer des applications accessibles pour les plateformes Apple, cool (en) : https://www.youtube.com/playlist?list=PLuw8_F_SfjQZiNRa4Gjl_mEy9OVl71d5H
- Nouvelle fonctionnalité de Eye Tracking sur iPhone (iOS 18) et iPad (en) : https://www.youtube.com/watch?v=7QquF_QqsdE

## Aides techniques

- Lecture par les AT des caractères spéciaux (en) : https://www.elevenways.be/en/articles/screenreaders-special-characters
...
- Considérations générales sur AI et texte de remplacement aux images, à lire (en) : https://equalentry.com/alt-text-accessibility-ai/
- Toujours sur AI et texte de remplacement, tests comparés (en) : https://tetralogical.com/blog/2025/03/24/can-generative-ai-write-contextual-text-descriptions/
- Diapos du CSUN ATC 2025 sur AI et images (en) : https://fr.slideshare.net/slideshow/verbose-ai_-the-accessibility-challenge-1-pptx/276534405
- Un point de vue sur AI et a11y (en) : https://karlgroves.com/ai-is-the-future-of-accessibility/
- Léonie Watson conférence sur l'AI, toujours pertinente Léonie (en) : https://www.youtube.com/watch?v=Ij-GLix2QUQm
...
- Smashing Magazine et a11y, des vidéos sympa (en) : https://css-tricks.com/smashing-meets-accessibility/
...
- Une jolie liste de plein d'outils, open-source, payants, gratuits etc. Toujours bon à connaitre (en) : https://pdfa.org/tools-for-accessible-pdf/
