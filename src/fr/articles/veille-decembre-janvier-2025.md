...
Un petit coucou à un mec que j'aime bien pour son franc-parler, Heydon Pickering ; ses principes de l'a11y sont en Français, et donc, une grande accolade pour l'un des traducteur, S. Deschamps et bravo aux autres  https://github.com/Heydon/principles-of-web-accessibility/blob/main/LISEZ-MOI.md. 
Et un petit point sur WCAG 3.0, ben ça avance mais  l'allure du W3c (rires) :D : (en) https://www.w3.org/news/2024/updated-drafts-for-review-w3c-accessibility-guidelines-wcag-3-0/ et (en) https://whollyaccessible.org/2024/12/11/wcag-3-december-24-update/.
...
- Le nouveau cadre juridique suit&e au EAA (European Accessibility Act) : https://www.usine-digitale.fr/article/services-numeriques-et-accessibilite-que-change-le-nouveau-cadre-juridique.N2225167
...
- AI et les testeurs, ça peut aider mais... (en) : ;https://www.tpgi.com/putting-ai-to-the-accessibility-test/
...
- Aria-label(ledby), a ne pas utiliser avec n'importe quelle balise, important (en) : https://benmyers.dev/blog/dont-use-aria-label-on-static-text-elements/
...
- Mettre des texte de remplacement aux images dans BlueSky (en) : https://bsky.app/profile/oedipusnj.bsky.social/post/3jywm7v5vtl2y
...
- Les its d'annotations ne font pas tout, à lire (en) : https://ericwbailey.website/published/accessibility-annotation-kits-only-annotate/#so%2C-what-can-we-do-about-this%3F
...
- Un utilisateur de lecteur d'écran et les sites d'état, à lire : https://www.sylduch-conseil.fr/creer-espace-pro-site-impots/
...
- Vous n'arrivez pas à atteindre certaines parties de l'UI en navigation clavier ? Peut-être avez-vous oublié l'existence des "Groupes de navigation au clavier" : https://cerovac.com/a11y/2024/12/testing-navigation-with-physical-keyboard-on-android-hint-keyboard-navigation-cluster/
- La compilation du calendrier de l'avent de Daniel Devesa iOS (en): https://dadederk.github.io/post/2024-12-06-01/
...
- Mobile Accessibility Advent Calendar (3 articles) Mark Steadman (en) :
...
- Concevoir de "jolis" et accessibles focus (en) : https://medienbaecker.com/articles/focus-outlines
...
- Des persona a11y avec des taches a réalise"r pour comprendre leurs difficultés, excellent (en) : https://personas-prototype.herokuapp.com/
...
- Ai et a11y, il faut de l'humain avec déficience, un point c'est tout, avis tranché (en) : https://ashleemboyer.com/blog/how-to-dehumanize-accessibility-with-ai