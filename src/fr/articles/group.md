...
Pour upn panneaux de commande pour la lecture d'un podcast, il est judicieux de mettre un `group` autour des boutons de contrôle de la lecture du son, c''est bien un groupe logique identifiable visuellement et donc a identifier pour les AT.
