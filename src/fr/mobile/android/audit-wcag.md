...
Orange a mis en place une grille de questions nommée la va11ydette.  Cette grille reprend 50 critères du standard WCAG version 2.2 de niveau A et AA, applicables aux applications mobiles, en plusieurs questions. Chaque question permet de valider ou d’invalider un seul critère à la fois, un critère peut être traité par une ou plusieurs questions. 
