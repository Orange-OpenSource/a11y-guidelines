...
En appliquant ce paramètrage, il vous sera plus facile de détecter les problèmes relevant d'une source d'iinformation fournie uniquement par la couleur.