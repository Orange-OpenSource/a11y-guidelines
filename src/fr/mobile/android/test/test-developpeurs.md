...
Orange propose son propre framework basé sur Espresso pour réaliser des vérifications automatique d'accessibilité. Des règles supplémentaires y sont notamment ajoutées. Il est donc recommandé d'utiliser ce framework accessible sur [<span lang="en">gitlab</span>](https://gitlab.tech.orange/soft_a11y/espresso-accessibility-orange).
