...
Orange a mis en place une grille de questions nommée la Va11ydette. Cette grille reprend les 55 critères du standard WCAG version 2.2 de niveau A et AA en plusieurs questions. Chaque question permet de valider ou d’invalider un ou plusieurs critères, un critère peut être traité par une ou plusieurs questions. 
