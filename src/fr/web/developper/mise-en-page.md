...
- Le contenu doit s'adapter à la largeur de l'écran, il doit être consultable (sauf besoin particulier : carte, tableau, diagramme...) sans défilement horizontal pour une zone d'affichage (<span lang="en">viewport</span>) réduite à 320 pixels CSS de large pour les contenus dont le sens de lecture est horizontal ou sans défilement vertical pour une zone d'affichage (<span lang="en">viewport</span>) réduite à 256 pixels CSS de haut pour les contenus dont le sens de lecture est vertical.
