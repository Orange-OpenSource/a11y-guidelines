...
documentTitles["fondamentaux-nontech.html#15-eviter-les-captcha"] = "15. Eviter les captcha";
index.add({
    url: "fondamentaux-nontech.html#15-eviter-les-captcha",
    title: "15. Eviter les captcha",    
    body: "## 15. Eviter les captcha **Cible&amp;nbsp;: ** tous les utilisateurs en particulier, les personnes déficientes visuelles.   **Quand&amp;nbsp;: ** lors de la conception et lors du développement.  **Description&amp;nbsp;:**   Les captcha sont souvent  la source de difficultés pour les utilisateurs. Si la mise en place d’un système anti-spam ne peut être évitée, il est souhaitable de s’orienter vers une solution plus souple pour l’utilisateur:  - Double authentification - Champ de formulaire caché à laisser vide (technique du &lt;span lang=\&quot;en\&quot;&gt;honeypot&lt;/span&gt;), non-visibles pour l’utilisateur - Mise à disposition d'un support téléphonique afin de s'assurer que le client est une vraie personne - Un contrôle permettant de s'assurer qu'une même combinaison IP/User agent ne tente pas de soumettre le formulaire plus de N fois par seconde.  Si aucune autre alternative n’est possible, il est indispensable de prévoir une alternative pour les captcha uniquement visuels ou sonores en proposant une  combinaison de captcha: un captcha  audio + visuel, des tests logiques (question dont la réponse est évidente, test  mathématique simple…) + captcha visuel clasique...  &amp;nbsp;  &lt;!--  This file is part of a11y-guidelines | Our vision of mobile &amp; web accessibility guidelines and best practices, with valid/invalid examples.  Copyright (C) 2016  Orange SA  See the Creative Commons Legal Code Attribution-ShareAlike 3.0 Unported License for more details (LICENSE file). --&gt;"
});
...
documentTitles["htmlaria.html#abbrhtmlabbr5-abbrariaabbr"] = "&lt;abbr&gt;HTML&lt;/abbr&gt;5 &amp; &lt;abbr&gt;ARIA&lt;/abbr&gt;";
index.add({
    url: "htmlaria.html#abbrhtmlabbr5-abbrariaabbr",
    title: "&lt;abbr&gt;HTML&lt;/abbr&gt;5 &amp; &lt;abbr&gt;ARIA&lt;/abbr&gt;",    
    body: "# &lt;abbr&gt;HTML&lt;/abbr&gt;5 &amp; &lt;abbr&gt;ARIA&lt;/abbr&gt;  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;&lt;abbr&gt;HTML&lt;/abbr&gt;5 &amp; &lt;abbr&gt;ARIA&lt;/abbr&gt;\&quot;}]); });&lt;/script&gt;  "
});
...
documentTitles["nos-outils.html#pourquoi-lutiliser"] = "Pourquoi l’utiliser ?";
index.add({
    url: "nos-outils.html#pourquoi-lutiliser",
...
documentTitles["nos-outils.html#extensions-a-installer-dans-votre-navigateur"] = "Extensions à installer dans votre navigateur";
index.add({
    url: "nos-outils.html#extensions-a-installer-dans-votre-navigateur",
