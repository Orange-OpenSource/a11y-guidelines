...
index.add({
    ...
    body: "## 27. Fournir des accès multiples et une localisation  ** Cible&amp;nbsp;:** tout le monde et en particulier les personnes déficientes visuelles ou cognitives.  ** Description&amp;nbsp;:** Donner à l’utilisateur plusieurs moyens de situer et accéder à un contenu spécifique, localiser la page Web en cours de consultation dans un ensemble de pages. Lorsque la page est une étape dans un processus où les pages s’enchaînent les unes après les autres, ce critère peut être ignoré.  ** À vérifier&amp;nbsp;:** S’assurer que plusieurs systèmes permettent de situer et accéder à une page ou un contenu dans le site&amp;nbsp;: un outil de recherche sur l’ensemble du site, un plan du site, un menu de navigation global, un fil d’Ariane… ** Objectif utilisateur&amp;nbsp;:** Permettre à tous les utilisateurs de se repérer afin d’accéder plus facilement à l’ensemble du contenu du site.  ** Exemple valide&amp;nbsp;:** Le site propose, à la fois, une navigation principale complète et précise et un fil d’Ariane.  ** Exemple invalide&amp;nbsp;:** Une application offre un menu de navigation parcellaire et aucun autre moyen pour l’utilisateur de s’orienter dans les pages ou de repérer où se situe la page courante dans l’arborescence.  **Référence WCAG&amp;nbsp;:** 2.4.5., 2.4.8  "
});

documentTitles["fondamentaux-tech.html#28-definir-des-zones-sensibles-de-taille-suffisante"] = "28. Définir des zones sensibles de taille suffisante";
index.add({
    url: "fondamentaux-tech.html#28-definir-des-zones-sensibles-de-taille-suffisante",
    title: "28. Définir des zones sensibles de taille suffisante",    
    body: "## 28. Définir des zones sensibles de taille suffisante  **Cible&amp;nbsp;:** tous les utilisateurs en particulier, les personnes souffrant de handicap moteur ou visuel et en mobilité.   **Quand&amp;nbsp;:** lors de la conception et lors du développement.  **Description&amp;nbsp;:**   Chaque zone sensible doit avoir une taille suffisante (9mm minimum de largeur et de hauteur). Par ailleurs les zones sensibles doivent être suffisamment espacées les unes des autres (environ 2mm minimum).  "
});

documentTitles["fondamentaux-tech.html#29-autoriser-lutilisation-du-zoom"] = "29. Autoriser l'utilisation du zoom";
index.add({
    url: "fondamentaux-tech.html#29-autoriser-lutilisation-du-zoom",
    title: "29. Autoriser l'utilisation du zoom",    
    body: "## 29. Autoriser l'utilisation du zoom  **Cible&amp;nbsp;:** tous les utilisateurs en particulier, les personnes déficientes visuelles.   **Quand&amp;nbsp;:** lors du développement.  **Description&amp;nbsp;:**   Le site ne doit pas interdire ou limiter l'utilisation du zoom (notamment sur les mobiles).  "
});

documentTitles["fondamentaux-tech.html#30-permettre-dannuler-le-declenchement-des-interactions-gestuelles"] = "30. Permettre d'annuler le déclenchement des interactions gestuelles";
index.add({
    url: "fondamentaux-tech.html#30-permettre-dannuler-le-declenchement-des-interactions-gestuelles",
    title: "30. Permettre d'annuler le déclenchement des interactions gestuelles",    
    body: "## 30. Permettre d'annuler le déclenchement des interactions gestuelles  **Cible&amp;nbsp;:** tous les utilisateurs en particulier, les personnes souffrant de handicap moteur ou visuel et en mobilité.   **Quand&amp;nbsp;:** lors du développement.  **Description&amp;nbsp;:**   Lors d'une interaction gestuelle, l'action est déclenchée uniquement à la fin de l'interaction de plus l'action n'est pas déclenchée si l'élément déclencheur perd le focus.  "
});

documentTitles["fondamentaux-tech.html#31-proposer-une-alternative-aux-gestuelles-complexes"] = "31. Proposer une alternative aux gestuelles complexes";
index.add({
    url: "fondamentaux-tech.html#31-proposer-une-alternative-aux-gestuelles-complexes",
    title: "31. Proposer une alternative aux gestuelles complexes",    
    body: "## 31. Proposer une alternative aux gestuelles complexes  **Cible&amp;nbsp;:** tous les utilisateurs en particulier, les personnes souffrant de handicap moteur ou visuel et en mobilité.   **Quand&amp;nbsp;:** lors de la conception et lors du développement.  **Description&amp;nbsp;:**   Pour chaque interaction gestuelle complexe, une alternative doit être disponible (par exemple une alternative non gestuelle ou simplifiée). De même pour les interactions nécessitant un changement d'orientation de l'écran (basculement, rotation, secouement...).  "
});

documentTitles["fondamentaux-tech.html#32-donner-acces-au-contenu-quelle-que-soit-lorientation-de-lecran"] = "32. Donner accès au contenu quelle que soit l'orientation de l'écran";
index.add({
    url: "fondamentaux-tech.html#32-donner-acces-au-contenu-quelle-que-soit-lorientation-de-lecran",
    title: "32. Donner accès au contenu quelle que soit l'orientation de l'écran",    
    body: "## 32. Donner accès au contenu quelle que soit l'orientation de l'écran  **Cible&amp;nbsp;:** tous les utilisateurs en particulier, les personnes souffrant de handicap moteur ou visuel et en mobilité.   **Quand&amp;nbsp;:** lors de la conception et lors du développement.  **Description&amp;nbsp;:**   L'accès au contenu ne doit pas dépendre de l'orientation de l'écran (portrait et paysage).  &lt;!--  This file is part of a11y-guidelines | Our vision of mobile &amp; web accessibility guidelines and best practices, with valid/invalid examples.  Copyright (C) 2016  Orange SA  See the Creative Commons Legal Code Attribution-ShareAlike 3.0 Unported License for more details (LICENSE file). --&gt;"
});
...
documentTitles["fondamentaux-nontech.html#16-eviter-les-captcha"] = "16. Éviter les captcha";
index.add({
    url: "fondamentaux-nontech.html#16-eviter-les-captcha",
    title: "16. Éviter les captcha",    
    body: "## 16. Éviter les captcha  **Cible&amp;nbsp;:** tous les utilisateurs en particulier, les personnes déficientes visuelles.   **Quand&amp;nbsp;:** lors de la conception et lors du développement.  **Description&amp;nbsp;:**   Les captcha sont souvent  la source de difficultés pour les utilisateurs. Si la mise en place d’un système anti-spam ne peut être évitée, il est souhaitable de s’orienter vers une solution plus souple pour l’utilisateur&amp;nbsp;:  - Double authentification&amp;nbsp;; - Champ de formulaire caché à laisser vide (technique du &lt;span lang=\&quot;en\&quot;&gt;honeypot&lt;/span&gt;), non-visibles pour l’utilisateur&amp;nbsp;; - Mise à disposition d'un support téléphonique afin de s'assurer que le client est une vraie personne&amp;nbsp;; - Un contrôle permettant de s'assurer qu'une même combinaison &lt;abbr&gt;IP&lt;/abbr&gt;/&lt;i lang=\&quot;en\&quot;&gt;User agent&lt;/i&gt; ne tente pas de soumettre le formulaire plus de N fois par seconde.  Si aucune autre alternative n’est possible, il est indispensable de prévoir une alternative pour les captcha uniquement visuels ou sonores en proposant une combinaison de captcha&amp;nbsp;:  - un captcha  audio&amp;nbsp;+ visuel, - des tests logiques (question dont la réponse est évidente, test  mathématique simple…)&amp;nbsp;+ captcha visuel clasique - …  "
});

documentTitles["fondamentaux-nontech.html#17-definir-des-zones-sensibles-de-taille-suffisante"] = "17. Définir des zones sensibles de taille suffisante";
index.add({
    url: "fondamentaux-nontech.html#17-definir-des-zones-sensibles-de-taille-suffisante",
    title: "17. Définir des zones sensibles de taille suffisante",    
    body: "## 17. Définir des zones sensibles de taille suffisante  **Cible&amp;nbsp;:** tous les utilisateurs en particulier, les personnes souffrant de handicap moteur ou visuel et en mobilité.   **Quand&amp;nbsp;:** lors de la conception et lors du développement.  **Description&amp;nbsp;:**   Chaque zone sensible doit avoir une taille suffisante (9mm minimum de largeur et de hauteur). Par ailleurs les zones sensibles doivent être suffisamment espacées les unes des autres (environ 2mm minimum).  "
});

documentTitles["fondamentaux-nontech.html#18-autoriser-lutilisation-du-zoom"] = "18. Autoriser l'utilisation du zoom";
index.add({
    url: "fondamentaux-nontech.html#18-autoriser-lutilisation-du-zoom",
    title: "18. Autoriser l'utilisation du zoom",    
    body: "## 18. Autoriser l'utilisation du zoom  **Cible&amp;nbsp;:** tous les utilisateurs en particulier, les personnes déficientes visuelles.   **Quand&amp;nbsp;:** lors du développement.  **Description&amp;nbsp;:**   Le site ne doit pas interdire ou limiter l'utilisation du zoom (notamment sur les mobiles).  "
});

documentTitles["fondamentaux-nontech.html#19-permettre-dannuler-le-declenchement-des-interactions-gestuelles"] = "19. Permettre d'annuler le déclenchement des interactions gestuelles";
index.add({
    url: "fondamentaux-nontech.html#19-permettre-dannuler-le-declenchement-des-interactions-gestuelles",
    title: "19. Permettre d'annuler le déclenchement des interactions gestuelles",    
    body: "## 19. Permettre d'annuler le déclenchement des interactions gestuelles  **Cible&amp;nbsp;:** tous les utilisateurs en particulier, les personnes souffrant de handicap moteur ou visuel et en mobilité.   **Quand&amp;nbsp;:** lors du développement.  **Description&amp;nbsp;:**   Lors d'une interaction gestuelle, l'action est déclenchée uniquement à la fin de l'interaction de plus l'action n'est pas déclenchée si l'élément déclencheur perd le focus.  "
});

documentTitles["fondamentaux-nontech.html#20-proposer-une-alternative-aux-gestuelles-complexes"] = "20. Proposer une alternative aux gestuelles complexes";
index.add({
    url: "fondamentaux-nontech.html#20-proposer-une-alternative-aux-gestuelles-complexes",
    title: "20. Proposer une alternative aux gestuelles complexes",    
    body: "## 20. Proposer une alternative aux gestuelles complexes  **Cible&amp;nbsp;:** tous les utilisateurs en particulier, les personnes souffrant de handicap moteur ou visuel et en mobilité.   **Quand&amp;nbsp;:** lors de la conception et lors du développement.  **Description&amp;nbsp;:**   Pour chaque interaction gestuelle complexe, une alternative doit être disponible (par exemple une alternative non gestuelle ou simplifiée). De même pour les interactions nécessitant un changement d'orientation de l'écran (basculement, rotation, secouement...).  "
});

documentTitles["fondamentaux-nontech.html#21-donner-acces-au-contenu-quelle-que-soit-lorientation-de-lecran"] = "21. Donner accès au contenu quelle que soit l'orientation de l'écran";
index.add({
    url: "fondamentaux-nontech.html#21-donner-acces-au-contenu-quelle-que-soit-lorientation-de-lecran",
    title: "21. Donner accès au contenu quelle que soit l'orientation de l'écran",    
    body: "## 21. Donner accès au contenu quelle que soit l'orientation de l'écran  **Cible&amp;nbsp;:** tous les utilisateurs en particulier, les personnes souffrant de handicap moteur ou visuel et en mobilité.   **Quand&amp;nbsp;:** lors de la conception et lors du développement.  **Description&amp;nbsp;:**   L'accès au contenu ne doit pas dépendre de l'orientation de l'écran (portrait et paysage).    &lt;!--  This file is part of a11y-guidelines | Our vision of mobile &amp; web accessibility guidelines and best practices, with valid/invalid examples.  Copyright (C) 2016  Orange SA  See the Creative Commons Legal Code Attribution-ShareAlike 3.0 Unported License for more details (LICENSE file). --&gt;"
});
...
index.add({
    ...
    title: "Méthodes et outils de test",    
    body: "# Méthodes et outils de test  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;Outils de test\&quot;}]); });&lt;/script&gt;  Orange évalue l’accessibilité d’une application ou d’un site à l’aide de trois méthodes complémentaires :  - **Évaluation technique :** inspecter le code et le contraste des couleurs pour mesurer la conformité des pages Web aux règles &lt;abbr&gt;WCAG&lt;/abbr&gt; 2.0 niveau AA. - **Évaluation fonctionnelle :** tester le comportement de l’interface avec différentes &lt;abbr&gt;aides techniques&lt;/abbr&gt; pour vérifier que les contenus évalués sont exempts de points bloquants. - **Évaluation utilisateur :** faire tester l’application par des utilisateurs en situation de handicap sur la base de tâches à accomplir afin de vérifier le niveau d’accessibilité du point de vue de l’utilisateur.     "
});

documentTitles["methodes-outils.html#evaluation-technique"] = "Évaluation technique";
index.add({
    url: "methodes-outils.html#evaluation-technique",
    title: "Évaluation technique",    
    body: "## Évaluation technique  Une partie des tests peut-être réalisée automatiquement par des outils, mais la majorité nécessite un contrôle manuel. Les tests automatisés sont à réaliser par les acteurs projet, les tests manuels essentiellement par les experts accessibilité.  Exemple d'outils :   - [Outils de tests automatique sur la page en cours de consultation](./methodes-outils-extensions.html)&amp;nbsp;: extension navigateur. - [Mesurer le niveau de contraste des couleurs](./methodes-outils-contrastes.html)&amp;nbsp;: présentation de l'outil &lt;span lang=\&quot;en\&quot;&gt;Colour Contrast Analyser&lt;/span&gt;.  "
});

documentTitles["methodes-outils.html#evaluation-fonctionnelle"] = "Évaluation fonctionnelle";
index.add({
    url: "methodes-outils.html#evaluation-fonctionnelle",
    title: "Évaluation fonctionnelle",    
    body: "## Évaluation fonctionnelle  Ces tests sont réalisés généralement par les experts accessibilité, ils peuvent également être menés par des acteurs projet.  Quelques exemples de tests : - [Navigation au clavier](./methodes-outils-clavier.html)&amp;nbsp;: liste des principaux raccourcis pour naviguer au clavier dans une page web. - [Agrandissement de la taille du texte](./methodes-outils-zoom.html)&amp;nbsp;: un guide sur la gestion du zoom. - [Navigation à l’aide d’un lecteur d’écran](./methodes-outils-lecteur-ecran.html)&amp;nbsp;: les principaux lecteurs d’écrans utilisés.  "
});

documentTitles["methodes-outils.html#evaluation-par-des-utilisateurs-en-situation-de-handicap"] = "Évaluation par des utilisateurs en situation de handicap";
index.add({
    url: "methodes-outils.html#evaluation-par-des-utilisateurs-en-situation-de-handicap",
    title: "Évaluation par des utilisateurs en situation de handicap",    
    body: "## Évaluation par des utilisateurs en situation de handicap  Ces tests consistent à faire faire à quelques utilisateurs cibles dont le poste (ou le mobile…) est équipé d’une aide technique particulière (loupe numérique d’écran, lecteur d’écran, clavier seul, plage braille) les  tâches principales de l’application. Ils permettent d’identifier les problèmes d’usage et de valider la criticité des anomalies rencontrées.    Ces tests sont conduits par des experts accessibilité.  &lt;!--  This file is part of a11y-guidelines | Our vision of mobile &amp; web accessibility guidelines and best practices, with valid/invalid examples.  Copyright (C) 2016  Orange SA  See the Creative Commons Legal Code Attribution-ShareAlike 3.0 Unported License for more details (LICENSE file). --&gt;"
});
...
index.add({
    ...
    body: "## &lt;span lang=\&quot;en\&quot;&gt;aXe accessibility audit&lt;/span&gt; [aXe](http://www.deque.com/axe/) est une extension disponible pour Chrome et Firefox permettant d’effectuer une série de tests basés sur les [WCAG](https://www.w3.org/WAI/intro/wcag).  ![capture d’écran de l’extension axe](images/aXe.png) &amp;nbsp;  "
});
...
index.add({
    ...
    title: "Les bases",    
    body: "## Les bases  &lt;ul class=\&quot;examples-list\&quot;&gt;     &lt;li&gt;         &lt;a href=\&quot;exemples/masquage/index.html\&quot;&gt;             &lt;img class=\&quot;hidden-sm-down\&quot; alt=\&quot;\&quot; src=\&quot;./images/exemples/masquage.png\&quot;&gt;&lt;span&gt;Masquage accessible&lt;/span&gt;         &lt;/a&gt;     &lt;/li&gt;     &lt;li&gt;         &lt;a href=\&quot;exemples/formulaire/index.html\&quot;&gt;             &lt;img class=\&quot;hidden-sm-down\&quot; alt=\&quot;\&quot; src=\&quot;./images/exemples/formulaire.png\&quot;&gt;&lt;span&gt;Gestion des formulaires&lt;/span&gt;         &lt;/a&gt;     &lt;/li&gt;     &lt;li&gt;         &lt;a href=\&quot;exemples/zoom/index.html\&quot;&gt;             &lt;img class=\&quot;hidden-sm-down\&quot; alt=\&quot;\&quot; src=\&quot;./images/exemples/zoom.png\&quot;&gt;&lt;span&gt;Gestion du zoom, agrandissement de la taille du texte&lt;/span&gt;         &lt;/a&gt;     &lt;/li&gt;     &lt;li&gt;         &lt;a href=\&quot;exemples/prix/index.html\&quot;&gt;             &lt;img class=\&quot;hidden-sm-down\&quot; alt=\&quot;\&quot; src=\&quot;./images/exemples/prix.png\&quot;&gt;&lt;span&gt;Affichage et vocalisation des prix&lt;/span&gt;         &lt;/a&gt;     &lt;/li&gt; &lt;/ul&gt;  "
});
