...
index.add({
    ...
    title: "Example 2",    
    body: "### Example 2 We have a button, a label and a switch control to be regrouped in a single block whose activation will change the switch control status automatically without defining any action like before. &lt;/br&gt;The easiest way would be to place the switch control in the middle of the created frame in order to locate its [accessibilityActivationPoint](#AccessibilityActivationPoint) directly on it. &lt;/br&gt;Unfortunately, that's not always possible. &lt;/br&gt;&lt;/br&gt;A new accessible element must then be created to gather all the desired objects and its **accessibilityActivationPoint** has to be defined on the switch control. &lt;/br&gt;&lt;img alt=\&quot;\&quot; style=\&quot;max-width: 350px; height: auto; \&quot; src=\&quot;./images/iOSdev/GrouperDesElements_2.png\&quot; /&gt; &lt;pre&gt;&lt;code class=\&quot;objective-c\&quot;&gt; @interface ActivationPointViewController ()  @property (weak, nonatomic) IBOutlet UIButton * myButton; @property (weak, nonatomic) IBOutlet UILabel * myLabel; @property (weak, nonatomic) IBOutlet UISwitch * mySwitch;  @end   @implementation ActivationPointViewController  - (void)viewDidAppear:(BOOL)animated {     [super viewDidAppear:animated];          UIAccessibilityElement * elt = [[UIAccessibilityElement alloc]initWithAccessibilityContainer:self.view];          CGRect a11yFirstEltFrame = CGRectUnion(_myLabel.frame, _myButton.frame);     CGRect a11yEltFrame = CGRectUnion(a11yFirstEltFrame, _mySwitch.frame);          elt.accessibilityLabel = @\&quot;regrouping elements\&quot;;     elt.accessibilityHint = @\&quot;double tap to change the switch control status\&quot;;     elt.accessibilityFrameInContainerSpace = a11yEltFrame;     elt.accessibilityActivationPoint = [_mySwitch center];          self.view.accessibilityElements = @[elt]; } @end &lt;/code&gt;&lt;/pre&gt;&lt;pre&gt;&lt;code class=\&quot;swift\&quot;&gt;     class ActivationPointViewController: UIViewController {      @IBOutlet weak var myButton: UIButton!     @IBOutlet weak var myLabel: UILabel!     @IBOutlet weak var mySwitch: UISwitch!               override func viewDidAppear(_ animated: Bool) {         super.viewDidAppear(animated)                  let elt = UIAccessibilityElement(accessibilityContainer: self.view)         let a11yEltFrame = (myLabel.frame.union(myButton.frame)).union(mySwitch.frame)          elt.accessibilityLabel = \&quot;regrouping elements\&quot;         elt.accessibilityHint = \&quot;double tap to change the switch control status\&quot;         elt.accessibilityFrameInContainerSpace = a11yEltFrame         elt.accessibilityActivationPoint = mySwitch.center          self.view.accessibilityElements = [elt]     } } &lt;/code&gt;&lt;/pre&gt;  Another grouping elements case could use the **shouldGroupAccessibilityChildren** attribute which is a Boolean that indicates whether &lt;span lang=\&quot;en\&quot;&gt;VoiceOver&lt;/span&gt; must group its children views. &lt;/br&gt;This allows making unique vocalizations or define a particular reading order for a part of the page (see &lt;a href=\&quot;http://a11y-guidelines.orange.com/mobile_EN/dev-ios.html#reading-order\&quot;&gt;Reading order&lt;/a&gt; section for further information). "
});
...
index.add({
    ...
    body: "### [Transparency and blurring (03:07)](https://developer.apple.com/videos/play/wwdc2018/230/?time=187) Since iOS 8, classes such as `UIBlurEffect` and `UIVisualEffectView` perfectly handle the blurring effect of an image. &lt;/br&gt;However, this could give rise to sighting difficulties for some people having visual problems. &lt;/br&gt;In this case, there's a possibility for the user to drastically weaken these effects by changing his settings. &lt;/br&gt;&lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-TransparencyAndBlurring_1.png\&quot; /&gt; &lt;/br&gt;The result is a darker background that may become completely uniform under certain circumstances. &lt;/br&gt;&lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-TransparencyAndBlurring_2.png\&quot; /&gt; &lt;/br&gt;The `isReduceTransparencyEnabled` property enables the developed application to be adapted to the user preference. &lt;/br&gt;&lt;img style=\&quot;max-width: 650px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-TransparencyAndBlurring_3.png\&quot; /&gt;  &lt;a name=\&quot;Contrast\&quot;&gt;&lt;/a&gt; "
});
...
index.add({
    ...
    body: "### [Contrast (04:38)](https://developer.apple.com/videos/play/wwdc2018/230/?time=278) The contrast between the foreground and the background colors is very important and depends a lot on the font type properties that are detailed in the [iOS guide section](./criteria-ios.html#colours) of this site. &lt;/br&gt;To improve the reading experience, it's natively possible to increase the colors contrast thanks to the settings. &lt;/br&gt;&lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-Contrast_1.png\&quot; /&gt; &lt;/br&gt;The `isDarkerSystemColorsEnabled` property enables the developed application to be adapted to the user preference. &lt;/br&gt;&lt;img style=\&quot;max-width: 650px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-Contrast_2.png\&quot; /&gt;  &lt;a name=\&quot;Sizing\&quot;&gt;&lt;/a&gt; "
});
...
index.add({
    ...
    body: "### [Motion (08:48)](https://developer.apple.com/videos/play/wwdc2018/230/?time=528) Any animations may give rise to problems of balance even of nausea to certain people. &lt;/br&gt;The user accessibility settings allow to strongly decrease the effects of all kind of native animations. &lt;/br&gt;&lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-Motion_1.png\&quot; /&gt; &lt;/br&gt;The `isReduceMotionEnabled` property enables the developed application to be adapted to the user preference. &lt;/br&gt;&lt;img style=\&quot;max-width: 600px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-Motion_2.png\&quot; /&gt;  &lt;a name=\&quot;UIAccessibilityElement\&quot;&gt;&lt;/a&gt; "
});
