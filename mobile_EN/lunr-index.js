...
index.add({
    ...
    body: "# Android accessibility guide  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;Android\&quot;, \&quot;url\&quot;: \&quot;./mobile-android.html\&quot;},                    {\&quot;label\&quot;:\&quot;Design criteria\&quot;}]);     addSubMenu([         {\&quot;label\&quot;:\&quot;Design criteria\&quot;,\&quot;url\&quot;:\&quot;criteria-android.html\&quot;, \&quot;expanded\&quot;: true},          {\&quot;label\&quot;:\&quot;Developers guide\&quot;,\&quot;url\&quot;:\&quot;dev-android.html\&quot;},         {\&quot;label\&quot;:\&quot;TalkBack\&quot;,\&quot;url\&quot;:\&quot;talkback.html\&quot;}     ]);     });&lt;/script&gt;  &lt;span data-menuitem=\&quot;mobile-android\&quot;&gt;&lt;/span&gt;  This guide aims to present the different accessibility criteria for getting an accessible Android application. Each criterion explains for whom it is important, when it can be implemented, why it is important and the corresponding accessibility rule. The criteria are explained through code snippets and real case examples. We invite you to install the [mDAN](./mdan.html) application for working examples of Talkback, the screen reader for Android, and other assistive tools. For more information on the tool (how to activate it, how to use it…) please refer to the [Talkback section](./talkback.html).  For the web, the level of accessibility to achieve to any HTML interface by the Orange group is the respect of the criteria of level AA of the Web Content Accessibility Guidelines (WCAG) 2.1, without blocking point following a test of user of technical help for the main scenarios for using the features of the site or application. For native mobile applications, a transposition of these criteria and compliance with the recommendations of the Android platform in terms of accessibility is requested, see these recommendations. The purpose is to explain these recommendations without replacing it.  "
});
...
index.add({
    ...
    title: "Colors",    
    body: "## Colors  **Target: ** everyone, especially people with visual impairments, elderly people and people with vision problems (colour blindness, vision contrasts etc.)   ** When: ** as of design and during development.  **Description: **  Colours have a very important role in the transmission of information. Some colours are associated with concepts or feelings but we must never forget the part of the population that does not correctly distinguish colours.  **Checklist: **  - Do not use colour as the only way of conveying information, indicating an action, requesting a response or distinguishing an element. - The contrast between the colour of the background and the text must be at least 7:1 and 4.5:1 for large font (can be measured with the Colour Contrast Analyser tool). Due to mobile constraints (screen, brightness,…) level AAA is required.  **Users’ goal: **   Ease of reading for all users, especially the visually impaired, or people in a very bright environment (outdoors). Allow users not distinguishing colours (colour blind, visually impaired, mobile users in bright environment…) to access the same information by other means.  ** Tools: ** The [Colour Contrast Analyser](http://www.paciellogroup.com/resources/contrastanalyser/) application can quickly measure colour contrast levels (free for Windows and Mac).    The [AccessibilityScanner application](https://play.google.com/store/apps/details?id=com.google.android.apps.accessibility.auditor) allows you to test quickly and simply the accessibility of your apps on some criteria including the colour contrast. Available on Android 6 and further.   ** Example of invalid contrast **   The label “film | 8:40 PM…” does not have enough contrast. It will not be readable by all users.    ![screenshot showing text with poor contrast](images/contraste.png)  ** Example of information conveyed through valid and invalid colour: **   &lt;img src=\&quot;./images/couleur.png\&quot; alt=\&quot;example of information conveyed through valid and invalid colour. In one case the color and the form of the object carries the information with a legend, in the other case only the color carries the information.\&quot; width=\&quot;300\&quot;&gt;     "
});
...
index.add({
    ...
    body: "## Content Control  **Target: ** everyone, especially people with visual and cognitive deficiencies.   ** When: ** as of design and during development.  **Description: **  On mobile, screen readers try to notify the user when there is a context change. In some cases, it can give constant vocalizations, and can therefore become inaudible, or prevent any user action. The user must control the content at all times. This is especially true with interactive content. So avoid video players launching directly in full screen mode, or videos starting automatically without user action, or a carousel scrolling automatically etc.  **Checklist: **  - All interactive content must be controllable by the user (pausing a carousel, adding an accessible button to exit full-screen mode, etc.).  **Users’ goal: **  Allow users to keep control on the application. Allow the screen reader user to avoid noise pollution which may affect navigation.  ** Technical goal: **  Improve natural indexation.   "
});
...
index.add({
    ...
    body: "## Focus-based navigation  **Target: ** everyone, especially people with motor impairments or people using keyboard.   ** When: ** as of design and during development.  **Description: **  Focus-based navigation is very useful for people with motor or cognitive difficulties. This navigation allows to go through the interactive elements (elements on which an action can be performed). This is the kind of navigation that you can have with a Bluetooth keyboard paired to a smartphone.  To handle focus-based navigation, make sure to: - Allow interactive elements to receive the focus: focus-based navigation only concerns interactive elements. If, for example, your application has clickable custom views, it must be ensured that these views are focusable by setting the `focusable` attribute to `true`. - Manage the focus order: through the `nextFocusDown`, `nextFocusUp`, `nextFocusRight`, `nextFocusLeft` options, you can specify what view should take the focus when using the down, up, right and left arrows. - Managing the focus display: interactive elements must have the `state_focused` defined and must be easily distinguishable when having the focus.  Note: `nextFocusDown`, `nextFocusUp`, `nextFocusRight`, `nextFocusLeft`, `focusable` and other focus management options are available either in the &lt;abbr&gt;xml&lt;/abbr&gt; or programmatically.    For more information on the [focus management on Android](http://developer.android.com/guide/topics/ui/accessibility/apps.html#focus-nav).   **Checklist: **  - The focusing order of navigation (keyboard) is logical and coherent. - It should be visually easy to determine the element that has focus.  **Users’ goal: **  Allow keyboard/dock tablet/sequential navigation device users to access the application.    "
});

documentTitles["criteria-android.html#screen-orientation"] = "Screen orientation";
index.add({
    url: "criteria-android.html#screen-orientation",
    title: "Screen orientation",    
    body: "## Screen orientation  **Target: ** everyone, especially people with visual or motor impairments.  ** When: ** as of design and during development.  **Description: ** Access to the content of an application must not depend on the orientation of the screen (portrait and landscape), unless a particular orientation is essential for understanding or using the content (projection, table…).  **Checklist: ** - Usage of standard graphic components that support both modes (fragments …), or define a `design` specific to each orientation. - The application is not locked in a mode (portrait or landscape).  **Users’ goal: ** - Ensure better readability of content for people who use magnification and move from portrait to landscape according to their need. - Ensure a better readability of the content for the devices fixed on support (hospital bed, wheelchair…).   &lt;!--  This file is part of a11y-guidelines | Our vision of mobile &amp; web accessibility guidelines and best practices, with valid/invalid examples.  Copyright (C) 2016  Orange SA  See the Creative Commons Legal Code Attribution-ShareAlike 3.0 Unported License for more details (LICENSE file). --&gt;"
});



documentTitles["criteria-ios.html#ios-design-criteria"] = "iOS design criteria";
index.add({
    url: "criteria-ios.html#ios-design-criteria",
    title: "iOS design criteria",    
    body: "# iOS design criteria  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;iOS\&quot;,\&quot;url\&quot;:\&quot;mobile-ios.html\&quot;},                    {\&quot;label\&quot;:\&quot;Design criteria\&quot;}]);     addSubMenu([         {\&quot;label\&quot;:\&quot;Design criteria\&quot;,\&quot;url\&quot;:\&quot;criteria-ios.html\&quot;, \&quot;expanded\&quot;: true},          {\&quot;label\&quot;:\&quot;Developers guide\&quot;,\&quot;url\&quot;:\&quot;dev-ios.html\&quot;},         {\&quot;label\&quot;:\&quot;VoiceOver\&quot;,\&quot;url\&quot;:\&quot;voiceover.html\&quot;},         {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},         {\&quot;label\&quot;:\&quot;Tests\&quot;,\&quot;url\&quot;:\&quot;criteria-ios-test.html\&quot;}     ]);         });&lt;/script&gt;  &lt;span data-menuitem=\&quot;mobile-ios\&quot;&gt;&lt;/span&gt;  This guide aims to present the different accessibility criteria for getting an accessible iOS application. &lt;/br&gt;Each criterion explains for whom it is important, when it can be implemented, why it is important and the corresponding accessibility rule.  "
});
...
index.add({
    ...
    title: "Colours",    
    body: "## Colours  ** Target: ** everyone, especially people with visual impairments, elderly people and people with vision problems (colour blindness, vision contrasts etc.)   ** When: ** as of the design phase and during development.  **Description: **  Colours have a very important role in the transmission of information. &lt;/br&gt;Some colours are associated with concepts or feelings but we must never forget the part of the population that does not correctly distinguish colours. &lt;/br&gt;&lt;/br&gt;The bold font type will allow a weaker contrast for the lowest font sizes. &lt;/br&gt;&lt;img style=\&quot;max-width: 1000px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/color_contrast_2.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt;The normal font type will require a higher contrast than the previous case. &lt;/br&gt;&lt;img style=\&quot;max-width: 1000px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/color_contrast_3.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt; With [Dynamic Type](./dev-ios.html#text-size) whose purpose is to increase the font size according to the user settings, the contrast isn't necessary fixed and must be adapted to the text size. &lt;/br&gt;&lt;img style=\&quot;max-width: 300px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/color_contrast_1.png\&quot; /&gt;  **Checklist: **  - Do not use colour as the only way of conveying information, indicating an action, requesting a response or distinguishing an element. - The contrast between the colour of the background and the text must be appropriate *(can be measured with the Colour Contrast Analyser tool)*.  **Users’ goal: **   Ease of reading for all users, especially the visually impaired, or people in a very bright environment (outdoors). Allow users who cannot distinguish colours or sensory information (colour blind, visually impaired, hearing impaired, mobile users in bright environment or in noisy environments…) to access the same information by other means.  ** Tools: ** The [Colour Contrast Analyser](http://www.paciellogroup.com/resources/contrastanalyser/) application can quickly measure colour contrast levels (free for Windows and Mac).    ** Example of invalid contrast **   The label “film | 8:40 PM…” does not have enough contrast. It will not be readable by all users.    ![screenshot showing text with poor contrast](images/contraste.png)  ** Example of information conveyed through valid and invalid colour: **   &lt;img src=\&quot;./images/couleur_ios.png\&quot; alt=\&quot;example of information conveyed through valid and invalid colour\&quot; width=\&quot;300\&quot;&gt;     "
});
...
documentTitles["criteria-ios.html#screen-orientation"] = "Screen orientation";
index.add({
    url: "criteria-ios.html#screen-orientation",
    title: "Screen orientation",    
    body: "## Screen orientation **Target&amp;nbsp;: ** everyone, especially people with visual and/or motor impairments.   **When&amp;nbsp;: ** as of design and during development.  **Description&amp;nbsp;: ** the screen orientation mustn't impact the access of an application content. &lt;/br&gt;It's highly recommended to : - **Implement both the portrait and the landscape modes** to be easily toggled by the user if it doesn't go against some functional constraints of the application itself (`serious game` for instance). - Provide for iPad screen sizes in order to facilitate reading and gestures.  **Checklist&amp;nbsp;: **  - Perfectly detailed design guideline including all the screens to be implemented with their possible orientation constraints. - Very accurate definition of the way the transitions between portrait and landscape modes should occur. - Portrait and landscape modes flawless adaptation to the content thanks to a bunch of graphic tests (very important for the `Dynamic Type`). - Appropriate settings in the integrated development environment. &lt;/br&gt;&lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/orientation.png\&quot; /&gt;  **Users’ goal&amp;nbsp;: ** improve a better legibility of the content.&lt;/br&gt;&lt;/br&gt;  "
});

documentTitles["criteria-ios.html#accessibility-options"] = "Accessibility options";
index.add({
    url: "criteria-ios.html#accessibility-options",
    title: "Accessibility options",    
    body: "## Accessibility options **Target&amp;nbsp;:** everyone.   **When&amp;nbsp;:** as of design and during development.  **Description&amp;nbsp;:** the accessibility options located in the mobile settings are all about to improve the experience of an impaired user who can be significantly helped by these options.  It's then primordial : - To **understand perfectly** each one of these options that can have an impact during the conception or the implementation periods of an application. - To ** test** each appropriate option so as to be sure that its purpose is completely taken into account inside the application.  The full list of these options including their purpose and their coding name is defined hereunder : 1. [Increase Contrast](#optionA11Y_contraste) 2. [AssistiveTouch](#optionA11Y_assistiveTouch) 3. [Bold Text](#optionA11Y_bold) 4. [Subtitles &amp; Captioning](#optionA11Y_closedCaption) 5. [Greyscale](#optionA11Y_grayScale) 6. [Guided Access](#optionA11Y_guidedAccess) 7. [Invert Colours](#optionA11Y_inverserLesCouleurs) 8. [Mono Audio](#optionA11Y_audioEnMono) 9. [Reduce Motion](#optionA11Y_limiteVisuel) 10. [Reduce Transparency](#optionA11Y_reductionTransparence) 11. [Shake to Undo](#optionA11Y_secouerPourAnnuler) 12. [Speak Screen](#optionA11Y_lecturePage) 13. [Speak Selection](#optionA11Y_speakSelection) 14. [Switch Control](#optionA11Y_switchontrol) 15. [VoiceOver](#optionA11Y_voiceOver)  &lt;a name=\&quot;optionA11Y_contraste\&quot;&gt;&lt;/a&gt; - **Increase Contrast** *(UIAccessibilityDarkerSystemColorsEnabled)* : see the [WWDC 2018 video](./dev-ios-wwdc-18230.html#Contrast). &lt;/br&gt;&lt;img style=\&quot;max-width: 600px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - Increase Contrast.\&quot; src=\&quot;./images/optionA11Y_contraste.png\&quot; /&gt; &lt;a name=\&quot;optionA11Y_assistiveTouch\&quot;&gt;&lt;/a&gt; - **AssistiveTouch** *(UIAccessibilityIsAssistiveTouchRunning)* : displays the homonymous menu in foreground, whatever the runnning application. &lt;/br&gt;&lt;img style=\&quot;max-width: 600px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - AssistiveTouch\&quot; src=\&quot;./images/optionA11Y_assistiveTouch.png\&quot; /&gt; &lt;a name=\&quot;optionA11Y_bold\&quot;&gt;&lt;/a&gt; - **Bold Text** *(UIAccessibilityIsBoldTextEnabled)* : see the [WWDC 2018 video](./dev-ios-wwdc-18230.html#Sizing). &lt;/br&gt;&lt;img style=\&quot;max-width: 600px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - Bold Text\&quot; src=\&quot;./images/optionA11Y_bold.png\&quot; /&gt; &lt;a name=\&quot;optionA11Y_closedCaption\&quot;&gt;&lt;/a&gt; - **Subtitles &amp; Captioning** *(UIAccessibilityIsClosedCaptioningEnabled)* : displays closed captioning or subtitles when available in the `appTV` or `Videos` app. &lt;/br&gt;&lt;img style=\&quot;max-width: 950px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - Subtitles &amp; Captioning\&quot; src=\&quot;./images/optionA11Y_closedCaptions.png\&quot; /&gt; &lt;a name=\&quot;optionA11Y_grayScale\&quot;&gt;&lt;/a&gt; - **Greyscale** *(UIAccessibilityIsGrayscaleEnabled)* : makes the display more readable for color blind people. &lt;/br&gt;&lt;img style=\&quot;max-width: 950px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - Display Accomodations - Colour Filters - Colour Filters\&quot; src=\&quot;./images/optionA11Y_grayScale.png\&quot; /&gt; &lt;a name=\&quot;optionA11Y_guidedAccess\&quot;&gt;&lt;/a&gt; - **Guided Access** *(UIAccessibilityIsGuidedAccessEnabled)* : restricts use of a single application. &lt;/br&gt;&lt;img style=\&quot;max-width: 950px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - Guided Access\&quot; src=\&quot;./images/optionA11Y_guidedAccess.png\&quot; /&gt; &lt;a name=\&quot;optionA11Y_inverserLesCouleurs\&quot;&gt;&lt;/a&gt; - **Invert Colours** *(UIAccessibilityIsInvertColorsEnabled)* : reduces glare and eye strain thanks to a very helpful mode for visual impaired people. &lt;/br&gt;&lt;img style=\&quot;max-width: 950px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - \&quot; src=\&quot;./images/optionA11Y_inverserLesCouleurs.png\&quot; /&gt; &lt;a name=\&quot;optionA11Y_audioEnMono\&quot;&gt;&lt;/a&gt; - **Mono Audio** *(UIAccessibilityIsMonoAudioEnabled)* : allows a complete hearing understanding with headset on without missing a word or a sound for people who are hard of hearing or deaf in one ear. &lt;/br&gt;&lt;img style=\&quot;max-width: 590px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - Mono Audio\&quot; src=\&quot;./images/optionA11Y_audioEnMono.png\&quot; /&gt; &lt;a name=\&quot;optionA11Y_limiteVisuel\&quot;&gt;&lt;/a&gt; - **Reduce Motion** *(UIAccessibilityIsReduceMotionEnabled)* : see the [WWDC 2018 video](./dev-ios-wwdc-18230.html#Motion). &lt;/br&gt;&lt;img style=\&quot;max-width: 950px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - Reduce Motion\&quot; src=\&quot;./images/optionA11Y_limiteVisuel.png\&quot; /&gt; &lt;a name=\&quot;optionA11Y_reductionTransparence\&quot;&gt;&lt;/a&gt; - **Reduce Transparency** *(UIAccessibilityIsReduceTransparencyEnabled)* : see the [WWDC 2018 video](./dev-ios-wwdc-18230.html#TransparencyAndBlurring). &lt;/br&gt;&lt;img style=\&quot;max-width: 950px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - Reduce Transparency\&quot; src=\&quot;./images/optionA11Y_reductionTransparence.png\&quot; /&gt; &lt;a name=\&quot;optionA11Y_secouerPourAnnuler\&quot;&gt;&lt;/a&gt; - **Shake to Undo** *(UIAccessibilityIsShakeToUndoEnabled)* : displays a menu to undo an action, preventing from holding backspace and watching all the letters disappear one by one for instance. &lt;/br&gt;&lt;img style=\&quot;max-width: 950px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - Shake to Undo\&quot; src=\&quot;./images/optionA11Y_secouerPourAnnuler.png\&quot; /&gt; &lt;a name=\&quot;optionA11Y_lecturePage\&quot;&gt;&lt;/a&gt; - **Speak Screen** *(UIAccessibilityIsSpeakScreenEnabled)* : launches the vocalization of the screen content. &lt;/br&gt;&lt;img style=\&quot;max-width: 950px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - Speak Screen\&quot; src=\&quot;./images/optionA11Y_lecturePage.png\&quot; /&gt; &lt;a name=\&quot;optionA11Y_speakSelection\&quot;&gt;&lt;/a&gt; - **Speak Selection** *(UIAccessibilityIsSpeakSelectionEnabled)* : displays a menu that suggests to speak the selection that fired it. &lt;/br&gt;&lt;img style=\&quot;max-width: 950px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - Speak Selection\&quot; src=\&quot;./images/optionA11Y_speakSelection.png\&quot; /&gt; &lt;a name=\&quot;optionA11Y_switchontrol\&quot;&gt;&lt;/a&gt; - **Switch Control** *(UIAccessibilityIsSwitchControlRunning)* : activates the feature in `point scanning mode` or in `item scanning mode`. &lt;/br&gt;&lt;img style=\&quot;max-width: 950px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - Switch Control\&quot; src=\&quot;./images/optionA11Y_switchontrol.png\&quot; /&gt; &lt;a name=\&quot;optionA11Y_voiceOver\&quot;&gt;&lt;/a&gt; - **VoiceOver** *(UIAccessibilityIsVoiceOverRunning)* : launches the screen reader. &lt;/br&gt;&lt;img style=\&quot;max-width: 950px; height: auto;\&quot; alt=\&quot;Access illustration via Settings - General - Accessibility - VoiceOver\&quot; src=\&quot;./images/optionA11Y_voiceOver.png\&quot; /&gt;  &lt;/br&gt;Once activated, if the accessibility option has no result in the application running, it's **highly recommended** to keep oneself posted of the impacted options states so as to provide the best experience to the user. &lt;/br&gt;The full list of the accessibility options with their dedicated notification is located in the [developer part](./dev-ios.html#accessibility-options) of this site. &lt;/br&gt;&lt;/br&gt;It may be particularly interesting to keep track of these options (de)activations with kind of indicators in order to have a better understanding of the users habits and to implement improvements accordingly.&lt;/br&gt;&lt;/br&gt;  &lt;!--  This file is part of a11y-guidelines | Our vision of mobile &amp; web accessibility guidelines and best practices, with valid/invalid examples.  Copyright (C) 2016  Orange SA  See the Creative Commons Legal Code Attribution-ShareAlike 3.0 Unported License for more details (LICENSE file). --&gt;"
});
...
index.add({
    ...
    body: "# How to test the iOS accessibility  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;iOS\&quot;, \&quot;url\&quot;: \&quot;./mobile-ios.html\&quot;},                    {\&quot;label\&quot;:\&quot;Tests\&quot;} 	]);     addSubMenu([         {\&quot;label\&quot;:\&quot;Design criteria\&quot;,\&quot;url\&quot;:\&quot;criteria-ios.html\&quot;},          {\&quot;label\&quot;:\&quot;Developers guide\&quot;,\&quot;url\&quot;:\&quot;dev-ios.html\&quot;},         {\&quot;label\&quot;:\&quot;VoiceOver\&quot;,\&quot;url\&quot;:\&quot;voiceover.html\&quot;},         {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},         {\&quot;label\&quot;:\&quot;Tests\&quot;,\&quot;url\&quot;:\&quot;criteria-ios-test.html\&quot;, \&quot;expanded\&quot;: true}     ]);	 });&lt;/script&gt;  &lt;span data-menuitem=\&quot;mobile-ios\&quot;&gt;&lt;/span&gt;  **ALL** the project members should know the iOS accessibility features introduced in this site to make a perfect link between the app implementations and the users needs. &lt;/br&gt;Each one of these features should be seen as an important **human-made** element for the user comfort and not just a functional one. &lt;/br&gt;Whatever the design, implementation or testing area, **every decision** must be particularly **empathetic** to provide the best user experience.&lt;/br&gt;&lt;/br&gt; "
});

documentTitles["criteria-ios-test.html#fundamental-prerequisites"] = "Fundamental prerequisites";
index.add({
    url: "criteria-ios-test.html#fundamental-prerequisites",
    title: "Fundamental prerequisites",    
    body: "### Fundamental prerequisites - Spend as much time as necessary to perfectly control the gestures ([VoiceOver](./voiceover.html), Switch Control).  - Watch the examples provided by the [WWDC videos](./dev-ios-wwdc.html). - Assimilate the [design criteria](./criteria-ios.html) to be sure that you're following the appropriate working path. - Create as many blank projects as needed to test a dedicated feature and be sure that it's working before introducing inside the final app coding global environment.&lt;/br&gt;&lt;/br&gt; "
});

documentTitles["criteria-ios-test.html#working-environment"] = "Working environment";
index.add({
    url: "criteria-ios-test.html#working-environment",
    title: "Working environment",    
    body: "### Working environment Four different groups may be described as parts of every project: - The **person in charge of defining the priorities of every functionality** must know the app users needs so as to accurately define the functionalities acceptance criteria and be able to check himself the desired achievement. - The **DESIGN** team must put itself in the user's shoes to provide recommendations as accurate as possible according to the project demands upstream. - The **DEVELOPMENT** team must rely heavily on the [WWDC videos](./dev-ios-wwdc.html) and the [iOS developers guide](./dev-ios.html) in order to find the most appropriate solutions. - The **TEST** team must perfectly control the [dedicated gesture](./voiceover.html) and understand every iOS accessibility feature to optimally perform every test before starting production.  Whatever the way you want to work *(SCRUM, ...)*, all the functions described above must be present in a project. &lt;/br&gt;&lt;/br&gt;Foresee two ways of evaluation in order to make sure that the iOS accessibility recommendations have been well implemented: - [**FUNCTIONAL**](#FunctionalMode): the **user navigation** among the screens must be hassle-free and provide all visual information without questions to be asked: **simple**, **clear** and **fluid**. - [**TECHNICAL**](#TechnicalMode): the technical compliance of some elements must be checked *(colours contrast, icons size...)* while creating code tests *(&lt;abbr&gt;TDD&lt;/abbr&gt;, &lt;abbr&gt;UI&lt;/abbr&gt;)*. Sometimes, this mode also confirms and solves any functional problems. &lt;/br&gt; &lt;a name=\&quot;FunctionalMode\&quot;&gt;&lt;/a&gt; "
});

documentTitles["criteria-ios-test.html#functional-review"] = "Functional review";
index.add({
    url: "criteria-ios-test.html#functional-review",
    title: "Functional review",    
    body: "## Functional review There's no need in having technical knowledge for this part but (de)activate and use iOS accessibility features. &lt;/br&gt;Besides the [design criteria](./criteria-ios.html) to be followed, it's crucial to be sure that the [accessibility options](./criteria-ios.html#accessibility-options) activated by a user are operational in the whole application. &lt;/br&gt;&lt;/br&gt;Few important criteria to be imperatively tested are introduced hereunder: - **Screen orientation**: it's highly recommended to implement the landscape and portrait modes. When implemented, this [functionality](./criteria-ios.html#screen-orientation) must be checked for each page of the application. - **Reduce motion** : because visual movements may give rise to problems *(nausea...)* for some people, it's imperative to check the [user settings dealing with animations](./criteria-ios.html#optionA11Y_limiteVisuel). - **Reduce transparency** : blurring effects may give rise to sighting difficulties for people having visual impairments. These effects can be weakened by the system thanks to an [accessibility option](./criteria-ios.html#optionA11Y_reductionTransparence) that must be checked in every page it occurs.  Besides these basic criteria, there are also fundamental requirements for an accessible application: - [Dynamic Type](#DynamicType) - [VoiceOver](#VoiceOver) - [Switch Control](#SwitchControl) &lt;/br&gt; &lt;a name=\&quot;DynamicType\&quot;&gt;&lt;/a&gt; "
});
...
index.add({
    ...
    title: "Dynamic Type",    
    body: "### Dynamic Type To understand how this feature works, it's highly recommended to watch the example in this [WWDC 2017 video](./dev-ios-wwdc-17245.html#Demo) that is detailed in the WWDC part of this site. &lt;/br&gt;Tests should be made with at least three devices having different screen sizes (**iPhone5SE**, **iPhoneX** and **iPhone8Plus** for instance) in order to **imperatively check every page**. &lt;/br&gt;&lt;/br&gt;Three zoom levels must be particularly scanned to determine the visual behavior at extremes: - Lowest threshold **WITHOUT** accessibility. - Highest threshold **WITHOUT** accessibility. - Highest threshold **WITH** accessibility.  &lt;img style=\&quot;max-width: 900px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/ios-test-DynamicType.png\&quot; /&gt; &lt;/br&gt;The following points must be thoroughly checked: - The **truncation '...' mustn't be used** and should be replaced by a hyphen at the end of the sentence. &lt;/br&gt;&lt;img style=\&quot;max-width: 200px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/ios-test-DynamicType_2.png\&quot; /&gt; - **Illustration and icon sizes must be adapted to the magnification**. 1/. Use of a central element like [tab bar items](./dev-ios.html#graphical-elements-size), 2/. a two fingers pinch implementation to avoid the `Zoom` native feature trigger or 3/. only a [graphical element magnification](./dev-ios.html#graphical-elements-size) are potential solutions according to the context. - **Change the text sizes in every screen** to ensure that all the elements perfectly meet the graphical contraints. - As soon as a **corrected fault** is effective, it **must be checked for every device used for tests** to be sure of its definitive rectification.  All these **tests are quite long to be performed** because every screen is impacted with different devices including the changing of the text size inside each one of them. &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;VoiceOver\&quot;&gt;&lt;/a&gt; "
});
...
index.add({
    ...
    title: "VoiceOver",    
    body: "### VoiceOver The iOS native screen reader activation drastically changes the visual behavior obtained with the common gestures, that's why its [control](./voiceover.html) takes a little while. &lt;/br&gt;It's **highly recommended** to know the basic gestures before activating this feature in the device user settings. &lt;/br&gt;&lt;img style=\&quot;max-width: 900px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/ios-test-voiceover.png\&quot; /&gt; &lt;/br&gt;Don't believe that every element must be absolutely vocalized one after another : that's definitely the proper way to get a VoiceOver implementation that is anything but effective ! &lt;/br&gt;&lt;/br&gt;Keep in mind that the visual **information** is assimilated very quickly while the screen reader provides **sequentially** this information at the speed of successive selections of elements: a **huge effort** is necessary to get a synoptic vision of the screen and really understand what's offered. &lt;/br&gt;&lt;/br&gt;To better deal with this situation, it's recommended to keep on navigating with the [curtain screen](./voiceover.html#CurtainScreen) mode that's particularly very useful for the tests of an unknown application because  no human-made memorized information from a previous browsing will be provided. &lt;/br&gt;&lt;/br&gt;Besides the [design criteria](./criteria-ios.html) to be followed, **four main principles** must be kept in mind when testing: - The visual information must be vocally transcribed. - The user must always know where he is and where he can go. - The user's navigation must he hassle-free, clear and fluid. - The number of element selections must be as small as possible.  All these **tests are quite long to be performed** and they require a strong empathy to suggest constructive criticism  of the vocally VoiceOver information. &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;SwitchControl\&quot;&gt;&lt;/a&gt; "
});

documentTitles["criteria-ios-test.html#switch-control"] = "Switch Control";
index.add({
    url: "criteria-ios-test.html#switch-control",
    title: "Switch Control",    
    body: "### Switch Control The accessibility [Switch Control](https://support.apple.com/en-en/HT201370) feature revolves around the **point mode** and the **item mode**. &lt;/br&gt;&lt;img style=\&quot;max-width: 600px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/ios-test-SwitchControl.png\&quot; /&gt; &lt;/br&gt;The element selection using the item mode works fine when the user interface isn't too complicated and uses native elements. &lt;/br&gt;&lt;/br&gt;However, this mode may not be helpful according to the rationale behind some specific use cases and then needs to be customized. &lt;/br&gt;In this case, the feedback information provided by the tests must be as helpful as getting the best user experience. &lt;/br&gt;&lt;/br&gt;*Note*: this feature can be (de)activated in the device user settings. &lt;/br&gt;&lt;img style=\&quot;max-width: 900px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/ios-test-SwitchControl_2.png\&quot; /&gt; &lt;/br&gt; &lt;a name=\&quot;TechnicalMode\&quot;&gt;&lt;/a&gt; "
});

documentTitles["criteria-ios-test.html#technical-review"] = "Technical review";
index.add({
    url: "criteria-ios-test.html#technical-review",
    title: "Technical review",    
    body: "## Technical review The use of this section requires more or less special expertise according to what must be checked. &lt;/br&gt;&lt;/br&gt; "
});

documentTitles["criteria-ios-test.html#colour-contrast"] = "Colour contrast";
index.add({
    url: "criteria-ios-test.html#colour-contrast",
    title: "Colour contrast",    
    body: "### Colour contrast The [colour contrast](./criteria-ios.html#colours) is certainly the easiest point to be checked thanks to softwares *(Colour Contrast Analyzer...)* or web sites *(WebAIM...)*. &lt;/br&gt;&lt;/br&gt; "
});

documentTitles["criteria-ios-test.html#code-review"] = "Code review";
index.add({
    url: "criteria-ios-test.html#code-review",
    title: "Code review",    
    body: "### Code review The Xcode &lt;abbr&gt;IDE&lt;/abbr&gt; contains a very interesting tool entitled **Accessibility Inspector**. &lt;/br&gt;Its goal and way of being used won't be developed here because they're perfectly explained in this detailed [WWDC video](./dev-ios-wwdc-16407.html) that's highly recommended to be watched. &lt;/br&gt;&lt;/br&gt; "
});

documentTitles["criteria-ios-test.html#code-testing"] = "Code testing";
index.add({
    url: "criteria-ios-test.html#code-testing",
    title: "Code testing",    
    body: "### Code testing Many kinds of tests *(&lt;abbr&gt;TDD&lt;/abbr&gt;*, *&lt;abbr&gt;UI&lt;/abbr&gt;)* may be set up by the developers in order to maintain a stable and reliable code over time. &lt;/br&gt;These good practice ensure functional continuity by being informed of any deviation introduced in subsequent developments. &lt;/br&gt;&lt;/br&gt;  &lt;!--  This file is part of a11y-guidelines | Our vision of mobile &amp; web accessibility guidelines and best practices, with valid/invalid examples.  Copyright (C) 2016  Orange SA  See the Creative Commons Legal Code Attribution-ShareAlike 3.0 Unported License for more details (LICENSE file). --&gt;"
});
...
index.add({
    ...
    body: "# Android developer guide  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;Android\&quot;, \&quot;url\&quot;: \&quot;./mobile-android.html\&quot;},                    {\&quot;label\&quot;:\&quot;Developers guide\&quot;}]);     addSubMenu([         {\&quot;label\&quot;:\&quot;Design criteria\&quot;,\&quot;url\&quot;:\&quot;criteria-android.html\&quot;},          {\&quot;label\&quot;:\&quot;Developers guide\&quot;,\&quot;url\&quot;:\&quot;dev-android.html\&quot;, \&quot;expanded\&quot;: true},         {\&quot;label\&quot;:\&quot;TalkBack\&quot;,\&quot;url\&quot;:\&quot;talkback.html\&quot;}     ]);     });&lt;/script&gt;  &lt;span data-menuitem=\&quot;mobile-android\&quot;&gt;&lt;/span&gt;  This guide aims to present the various accessibility options available on the Android &lt;abbr&gt;SDK&lt;/abbr&gt;. Through different categories, this guide explains how to use the accessibility attributes&amp;nbsp;/ methods and provides links to the official Google documentation. Code snippets are also available to show you how to implement it.    "
});
...
documentTitles["dev-android.html#description"] = "Description:";
index.add({
    url: "dev-android.html#description",
    title: "Description:",    
    body: "### Description:   On Android, the vocalization of an element is made through an attribute named `contentDescription`. This attribute, which accepts a single string parameter (and therefore localizable), completely redefines the text to be read by an accessibility service like TalkBack. This allows a component to be more explicit than the text displayed on the screen. For example, in the case of a button whose title is “OK”, the `contentDescription` attribute can indicate that the button is used to confirm an action.  The `contentDescription` attribute must also be used on custom elements to indicate their nature. For example, a clickable `LinearLayout` must have a `contentDescription` like “button_name, button” (it should also be focusable to be properly accessible, see the corresponding section).   Note that the `contentDescription` is available in any element that inherits from `View`. It is therefore possible to set a `contentDescription` on a `TextView` for example, as shown in the “accessibility guide - text alternative - abbreviations, dates and times” section.   "
});

documentTitles["dev-android.html#examples"] = "Examples:";
index.add({
    url: "dev-android.html#examples",
    title: "Examples:",    
    body: "### Examples:  Simple example (localized): &lt;pre&gt;&lt;code class=\&quot;xml\&quot;&gt;&amp;lt;TextView … android:id=\&quot;@+id/myTextviewId\&quot; android:contentDescription=\&quot;@string/criteria_alt_ex1_cd_txt2\&quot; &amp;#47;&amp;gt;&lt;/code&gt;&lt;/pre&gt;&lt;pre&gt; &lt;code class=\&quot;java\&quot;&gt;myTextView = (TextView) findViewById(R.id.myTextviewId); myTextView.setContentDescription(getString(R.string.criteria_alt_ex1_cd_txt2));&lt;/code&gt;&lt;/pre&gt;&lt;pre&gt;&lt;code class=\&quot;kotlin\&quot;&gt;myTextViewId.contentDescription = getString(R.string.criteria_alt_ex1_cd_txt2)&lt;/code&gt;&lt;/pre&gt;  Example of a `Tab`:   The example has tabs above and below a `ViewPager` in one case in` TabLayout` and in the other in `BottomNavigationView`. The tabs are no longer coded in `TabHost` component. It is necessary to indicate the state and the nature of the tabs (not internationalized):  &lt;pre&gt;&lt;code class=\&quot;xml\&quot;&gt;//In the layout of the activity &amp;lt;android.support.constraint.ConstraintLayout    …&amp;gt;     &amp;lt;android.support.v4.view.ViewPager     android:id=\&quot;@+id/viewpager\&quot;         …         &amp;gt;     &amp;lt;android.support.design.widget.TabLayout             android:id=\&quot;@+id/tabtoolbar_pager\&quot;             …     &amp;lt;/android.support.v4.view.ViewPager&amp;gt;     &amp;lt;android.support.design.widget.BottomNavigationView         android:id=\&quot;@+id/navigation\&quot;         […]         app:menu=\&quot;@menu/navigation\&quot; /&amp;gt; &amp;lt;/android.support.constraint.ConstraintLayout&amp;gt; &amp;nbsp; &amp;nbsp; //In the file strings.xml &amp;lt;string name=\&quot;cd_tab_title_param\&quot;&amp;gt;%1$s, tab %2$s on %3$s&amp;lt;/string&amp;gt; &lt;/code&gt;&lt;/pre&gt;&lt;pre&gt; &lt;code class=\&quot;java\&quot;&gt;     @Override     protected void onCreate(Bundle savedInstanceState) {         super.onCreate(savedInstanceState);         setContentView(R.layout.activity_main);         mTabLayout = (TabLayout) findViewById(R.id.tabtoolbar_pager);         mViewPager = (ViewPager) findViewById(R.id.viewpager);         mTabLayout.addOnLayoutChangeListener(mTabLayoutListener);         mTabLayout.setupWithViewPager(mViewPager);         mAdapter = new ScreenSlidePagerAdapter(getSupportFragmentManager());         mViewPager.setAdapter(mAdapter); //At creation, initialize the contentDescription         updateTabContentDescription(0);         mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {             […]             public void onPageSelected(int position) {                 updateTabContentDescription(position);             }         }); //The BottomNavigationView is not necessarily at the bottom of the view, its position is defined in the layout.         BottomNavigationView navigation = (BottomNavigationView) findViewById(R.id.navigation);         navigation.setOnNavigationItemSelectedListener(mOnNavigationItemSelectedListener);         […]         }     private void updateTabContentDescription(int position) {         for (int i = 0; i &amp;lt; mAdapter.getCount(); i++) {             TabLayout.Tab tab = mTabLayout.getTabAt(i);             String cd_param_string = getString(R.string.cd_tab_title_param,                     mAdapter.getPageTitle(i), // title, first parameter see xml                     i + 1,                    // tab number, second parameter                     mAdapter.getCount());     // total number of tabs, third parameter             if (tab != null) {                 tab.setContentDescription(cd_param_string);             }          //For Tablayout and BottomNavigationView, information “selected” is already vocalized. //Either, for example: “selected, `tab title 1`, tab 1 of 5” //or “`tab title 3`, tab 3 of 5”. Then “Double-tap to activate”. // Setting the upper bound automatically will prevent a vocalization like: //“selected, `tab title 4`, tab 4 of 3.\&quot;, where the upper bound is inconsistent. // For the `TabHost` implementation, it would be necessary to specify the \&quot;selected\&quot; state of the tab.         }     } &lt;/code&gt;&lt;/pre&gt;&lt;pre&gt; &lt;code class=\&quot;kotlin\&quot;&gt;     private fun updateTabContentDescription(position: Int) {         for (i in 0 until mAdapter!!.count) {             val tab = mTabLayout!!.getTabAt(i)             val cd_param_string = getString(R.string.cd_tab_title_param,                     mAdapter!!.getPageTitle(i), // titre en paramètre 1 voir le xml                     i + 1,                      // le numéro de l’onglet actuel, paramètre 2                     mAdapter!!.count)           // le nombre d’onglets automatique, paramètre 3             if (tab != null) {                 tab.contentDescription = cd_param_string //For Tablayout and BottomNavigationView, information “selected” is already vocalized. //Either, for example: “selected, `tab title 1`, tab 1 of 5” //or “`tab title 3`, tab 3 of 5”. Then “Double-tap to activate”. // Setting the upper bound automatically will prevent with a vocalization like: //“selected, `tab title 4`, tab 4 of 3.\&quot;, where the upper bound is inconsistent. // For the `TabHost` implementation, it would be necessary to specify the \&quot;selected\&quot; state of the tab.             }         }     } &lt;/code&gt;&lt;/pre&gt;  **Link: **  - [`contentDescription`](https://developer.android.com/reference/android/view/View.html#attr_android:contentDescription)     "
});
...
index.add({
    ...
    body: "## Hiding elements from accessibility    "
});
...
index.add({
    url: "dev-android.html#link",
    title: "Link:",    
    body: "### Link:  - [`announceForAccessibility`](https://developer.android.com/reference/android/view/View.html#announceForAccessibility%28java.lang.CharSequence%29)   "
});
...
index.add({
    url: "dev-android.html#description",
    title: "Description:",    
    body: "### Description:  On Android, it is possible to know whether the Accessibility API is enabled, thus whether TalkBack is enabled.  "
});

documentTitles["dev-android.html#usage"] = "Usage:";
index.add({
    url: "dev-android.html#usage",
    title: "Usage:",    
    body: "### Usage:  &lt;pre&gt;&lt;code class=\&quot;java\&quot;&gt;AccessibilityManager am = (AccessibilityManager) context.getSystemService(ACCESSIBILITY_SERVICE);   boolean isAccessibilityEnabled = am.isEnabled(); &lt;/code&gt;&lt;/pre&gt;&lt;pre&gt; &lt;code class=\&quot;kotlin\&quot;&gt;val am = context.getSystemService(Context.ACCESSIBILITY_SERVICE) as AccessibilityManager val isAccessibilityEnabled = am.isEnabled &lt;/code&gt;&lt;/pre&gt;   "
});
...
index.add({
    ...
    body: "## Live region (dynamic content)  "
});
...
index.add({
    url: "dev-android.html#example",
    title: "Example:",    
    body: "### Example:  &lt;pre&gt;&lt;code class=\&quot;xml\&quot;&gt;&amp;lt;TextView    […]    android:accessibilityLiveRegion=\&quot;polite\&quot; /&amp;gt;&lt;/code&gt;&lt;/pre&gt;  "
});
...
index.add({
    url: "dev-android.html#link",
    title: "Link:",    
    body: "### Link:  - [`setAccessibilityLiveRegion`](https://developer.android.com/reference/android/view/View.html#setAccessibilityLiveRegion%28int%29)   "
});
...
index.add({
    url: "dev-android.html#description",
    title: "Description:",    
    body: "### Description:    By default, the reading order of voice synthesis depends on: the “logical” reading (in France), from left to right and top to bottom, and the &lt;abbr&gt;xml&lt;/abbr&gt; order (order of elements declaration). It is quite possible to redefine the reading order with two attributes:   - `AccessibilityTraversalAfter`: sets the `id` of a view after which this one is visited in accessibility traversal. A screen-reader must visit the content of the other view before the content of this one. - `AccessibilityTraversalBefore`: sets the `id` of a view before which this one is visited in accessibility traversal. A screen-reader must visit the content of this view before the content of the one it precedes.  Note: These attributes can be used directly in the &lt;abbr&gt;xml&lt;/abbr&gt; but also in the code via the `setAccessibilityTraversalBefore` and `setAccessibilityTraversalAfter` methods. These methods are available for any element that inherits from `View`.  "
});
...
index.add({
    url: "dev-android.html#example",
    title: "Example:",    
    body: "### Example:  &lt;pre&gt;&lt;code class=\&quot;java\&quot;&gt;volupButton.setAccessibilityTraversalAfter(myView.findViewById(R.id.remote0).getId()); voldownButton.setAccessibilityTraversalAfter(myView.findViewById(R.id.volup).getId()); chaineplusButton.setAccessibilityTraversalAfter(myView.findViewById(R.id.voldown).getId()); chainemoinsButton.setAccessibilityTraversalAfter(myView.findViewById(R.id.chaineplus).getId());&lt;/code&gt;&lt;/pre&gt;&lt;pre&gt; &lt;code class=\&quot;kotlin\&quot;&gt;volupButton.accessibilityTraversalAfter = remote0Button.id voldownButton.accessibilityTraversalAfte = volupButton.id chaineplusButton.accessibilityTraversalAfter = voldownButton.id chainemoinsButton.accessibilityTraversalAfter = chaineplusButton.id&lt;/code&gt;&lt;/pre&gt;  "
});
...
index.add({
    url: "dev-android.html#link",
    title: "Link:",    
    body: "### Link:    - [`setAccessibilityTraversalAfter`](https://developer.android.com/reference/android/view/View.html#setAccessibilityTraversalAfter%28int%29) - [`setAccessibilityTraversalBefore`](https://developer.android.com/reference/android/view/View.html#setAccessibilityTraversalBefore%28int%29)  "
});

documentTitles["dev-android.html#manage-the-reading-of-headers-talkback"] = "Manage the reading of headers (TalkBack)";
index.add({
    url: "dev-android.html#manage-the-reading-of-headers-talkback",
    title: "Manage the reading of headers (TalkBack)",    
    body: "## Manage the reading of headers (TalkBack) Android &lt;i&gt;Pie&lt;/i&gt; introduces an additional level of reading of the `accessibilityHeading` feature that allows you to browse the page on these titles instead of all the elements of the page.  "
});

documentTitles["dev-android.html#descriptionnbsp"] = "Description&amp;nbsp;:";
index.add({
    url: "dev-android.html#descriptionnbsp",
    title: "Description&amp;nbsp;:",    
    body: "### Description&amp;nbsp;: The screen reader can read only the headers defined in a page (see the TalkBack User Guide, the “Slide Up Using a Finger” gesture). These headers allow the reader to browse the large sections of the page to see if the information sought is there, without having to listen to everything.  "
});

documentTitles["dev-android.html#examplenbsp"] = "Example&amp;nbsp;:";
index.add({
    url: "dev-android.html#examplenbsp",
    title: "Example&amp;nbsp;:",    
    body: "#### Example&amp;nbsp;: &lt;pre&gt;&lt;code class=\&quot;xml\&quot;&gt;&amp;lt;TextView […] android:id=\&quot;@+id/myTextLevel1viewId\&quot; android:accessibilityHeading=\&quot;true\&quot; &amp;#47;&amp;gt;&lt;/code&gt;&lt;/pre&gt;  "
});
...
index.add({
    url: "dev-android.html#link",
    title: "Link:",    
    body: "#### Link: - [`accessibilityHeading`](https://developer.android.com/reference/android/R.attr#accessibilityHeading)  "
});
...
index.add({
    url: "dev-android.html#description",
    title: "Description:",    
    body: "### Description:  It is very important to bind the form fields with their labels. There are 2 major techniques to achieve this:  - `LabelFor`: allow to specify a label to a view. This method takes the `id` of the view that it is associated with. This method can be used on almost any type of form field. We can also use the &lt;abbr&gt;xml&lt;/abbr&gt; `android:labelFor` or programmatically `setLabelFor`.  - `Hint`: add an example text when the text field is empty. This method only works for `TextView`. Supports setting the `id` to a string. Can be used in the &lt;abbr&gt;xml&lt;/abbr&gt; `android:hint` or programmatically `setHint`.  "
});
...
index.add({
    url: "dev-android.html#examples",
    title: "Examples:",    
    body: "### Examples:  `LabelFor` in &lt;abbr&gt;XML&lt;/abbr&gt;:  &lt;pre&gt;&lt;code class=\&quot;xml\&quot;&gt;&amp;lt;TextView 	[...]   android:labelFor=\&quot;@+id/imageView11\&quot;   android:importantForAccessibility=\&quot;no\&quot; /&amp;gt;&lt;/code&gt;&lt;/pre&gt;  Note: It is very common, once the label is bound to its field, to hide the label from the accessibility service. This is because this one does not need to be vocalized by the Accessibility &lt;abbr&gt;API&lt;/abbr&gt; anymore as it’s already associated with the form field (and will be vocalized by TalkBack for example).  `Hint` in &lt;abbr&gt;xml&lt;/abbr&gt;: &lt;pre&gt;&lt;code class=\&quot;xml\&quot;&gt;&amp;lt;EditText   [...]    android:hint=\&quot;@string/criteria_form_ex1_placeholder\&quot; /&amp;gt;&lt;/code&gt;&lt;/pre&gt;  "
});

documentTitles["dev-android.html#links"] = "Links:";
index.add({
    url: "dev-android.html#links",
    title: "Links:",    
    body: "### Links:  - [`setLabelFor`](https://developer.android.com/reference/android/view/View.html#setLabelFor%28int%29) - [`setHint`](https://developer.android.com/reference/android/widget/TextView.html#setHint%28java.lang.CharSequence%29)   "
});
...
index.add({
    url: "dev-android.html#description",
    title: "Description:",    
    body: "### Description:   To make it possible for the “Huge font size” option to properly interact with the application, several points are to be respected during the development: - Use dynamic font size: the “sp”. This unit, specific to Android, allows to have a font size proportional to the pixel density of the display. It is highly recommended to use it for text, if only for a uniform design on all types of Android devices. - Manage content overflows: A common mistake is to use a dynamic text size (“sp”) but not to pay attention to the container size. If the text gets bigger, the container must adapt so there is no overflow. One can perfectly play with the `min-height` and `height` attributes for correct results (the `height` set to `wrap_content` and `min-height` set to the default desired height).  "
});
...
index.add({
    url: "dev-android.html#link",
    title: "Link:",    
    body: "### Link:  - [typography](https://www.google.com/design/spec/style/typography.html#typography-styles)      "
});
...
index.add({
    ...
    body: "## Accessibility events &amp; custom views  "
});
...
index.add({
    url: "dev-android.html#links",
    title: "Links:",    
    body: "### Links:  - [`AccessibilityEvents`](http://developer.android.com/reference/android/view/accessibility/AccessibilityEvent.html) - [Creating a custom view](http://developer.android.com/guide/topics/ui/accessibility/apps.html#custom-views) - [Accessibility Event Skeleton sample](https://github.com/Pascale22/A11yEventApp) in &lt;abbr&gt;Kotlin&lt;/abbr&gt;     "
});
...
index.add({
    url: "dev-android.html#description",
    title: "Description:",    
    body: "#### Description:  Sometimes lists are not vocalized correctly: the speech synthesis is trying to vocalize the whole list at once (only the items displayed on the screen). This is especially the case when using the `RecyclerView`. To overcome this problem, there is a simple fix. Just set the `focusable` attribute to `true` for each item in the list. This has the effect of forcing the speech synthesis (TalkBack) to read the items one by one.   "
});
...
index.add({
    ...
    body: "## Navigating via the focus (keyboard)  "
});
...
index.add({
    url: "dev-android.html#description",
    title: "Description:",    
    body: "#### Description:  To handle focus-based navigation, make sure to: - Allow interactive elements to receive the focus: focus-based navigation only concerns interactive elements. If, for example, your application has clickable custom views, it must be ensured that these views are focusable setting the `focusable` attribute to `true`. - Managing the focus display: interactive elements must have the `state_focused` defined and must be easily distinguishable when having the focus. - Managing the focus order: through the `nextFocusDown`, `nextFocusUp`, `nextFocusRight`, `nextFocusLeft` options, you can specify what view should take the focus when using the down, up, right and left arrow.  Most of the time, only the two first points must be taken care of. Android is able to determine very precisely the positions of the elements between them and therefore to provide a logical and coherent reading order for the keyboard.  Note: `nextFocusDown`, `nextFocusUp`, `nextFocusRight`, `nextFocusLeft`, `focusable` and other focus management options are available either in the &lt;abbr&gt;xml&lt;/abbr&gt; or programmatically.  Note: Android Pie (9, &lt;abbr&gt;API&lt;/abbr&gt; 28) introduces a screen reader-specific focus to avoid edge effects between the screen reader focus (`screenReaderFocusable`) and the keyboard focus (`focusable`). Keyboard navigation is not sensitive to `screenReaderFocusable`.  "
});
...
index.add({
    url: "dev-android.html#example",
    title: "Example:",    
    body: "#### Example:  Selector handling the `state_focused`: &lt;pre&gt;&lt;code class=\&quot;xml\&quot;&gt;&amp;lt;selector xmlns:android=\&quot;http://schemas.android.com/apk/res/android\&quot;&amp;gt; 	&amp;lt;!-- Non focused states --&amp;gt; 	&amp;lt;item android:state_focused=\&quot;false\&quot; android:state_selected=\&quot;false\&quot; android:state_pressed=\&quot;false\&quot; android:drawable=\&quot;@drawable/tab_unselected_tab_selector\&quot; /&amp;gt; 	&amp;lt;item android:state_focused=\&quot;false\&quot; android:state_selected=\&quot;true\&quot;  android:state_pressed=\&quot;false\&quot; android:drawable=\&quot;@drawable/tab_selected_tab_selector\&quot; /&amp;gt; &amp;nbsp; 	&amp;lt;!-- Focused states --&amp;gt; 	&amp;lt;item android:state_focused=\&quot;true\&quot; android:state_selected=\&quot;false\&quot; android:state_pressed=\&quot;false\&quot; android:drawable=\&quot;@drawable/tab_unselected_focused_tab_selector\&quot; /&amp;gt; 	&amp;lt;item android:state_focused=\&quot;true\&quot; android:state_selected=\&quot;true\&quot;  android:state_pressed=\&quot;false\&quot; android:drawable=\&quot;@drawable/tab_selected_focused_tab_selector\&quot; /&amp;gt; &amp;nbsp; 	&amp;lt;!-- Pressed --&amp;gt; 	&amp;lt;!-- Non focused states --&amp;gt; 	&amp;lt;item android:state_focused=\&quot;false\&quot; android:state_selected=\&quot;false\&quot; android:state_pressed=\&quot;true\&quot; android:drawable=\&quot;@drawable/tab_unselected_pressed_tab_selector\&quot; /&amp;gt; 	&amp;lt;item android:state_focused=\&quot;false\&quot; android:state_selected=\&quot;true\&quot;  android:state_pressed=\&quot;true\&quot; android:drawable=\&quot;@drawable/tab_selected_pressed_tab_selector\&quot; /&amp;gt; &amp;nbsp; 	&amp;lt;!-- Focused states --&amp;gt; 	&amp;lt;item android:state_focused=\&quot;true\&quot; android:state_selected=\&quot;false\&quot; android:state_pressed=\&quot;true\&quot; android:drawable=\&quot;@drawable/tab_unselected_pressed_tab_selector\&quot; /&amp;gt; 	&amp;lt;item android:state_focused=\&quot;true\&quot; android:state_selected=\&quot;true\&quot;  android:state_pressed=\&quot;true\&quot; android:drawable=\&quot;@drawable/tab_selected_pressed_tab_selector\&quot; /&amp;gt; &amp;lt;/selector&amp;gt;&lt;/code&gt;&lt;/pre&gt;  "
});
...
index.add({
    ...
    body: "# iOS developer guide  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;iOS\&quot;,\&quot;url\&quot;:\&quot;mobile-ios.html\&quot;},                    {\&quot;label\&quot;:\&quot;Developers guide\&quot;}]);     addSubMenu([         {\&quot;label\&quot;:\&quot;Design criteria\&quot;,\&quot;url\&quot;:\&quot;criteria-ios.html\&quot;},          {\&quot;label\&quot;:\&quot;Developers guide\&quot;,\&quot;url\&quot;:\&quot;dev-ios.html\&quot;, \&quot;expanded\&quot;: true},         {\&quot;label\&quot;:\&quot;VoiceOver\&quot;,\&quot;url\&quot;:\&quot;voiceover.html\&quot;},         {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},         {\&quot;label\&quot;:\&quot;Tests\&quot;,\&quot;url\&quot;:\&quot;criteria-ios-test.html\&quot;}     ]);         });&lt;/script&gt;  &lt;span data-menuitem=\&quot;mobile-ios\&quot;&gt;&lt;/span&gt;  This guide aims to present the various iOS &lt;abbr&gt;SDK&lt;/abbr&gt; accessibility options. &lt;/br&gt;Through different categories, this guide explains how to use the accessibility attributes&amp;nbsp;/ methods and provides links to the [`Apple official documentation`](https://developer.apple.com/documentation/uikit/accessibility). &lt;/br&gt;Code snippets are also available to show the different possible implementations {(Swift 5.0, Objective C) + (Xcode 10, iOS 12)}.  &lt;a name=\&quot;AccessibilityTraits\&quot;&gt;&lt;/a&gt; "
});
...
index.add({
    ...
    title: "Example",    
    body: "### Example &lt;pre&gt;&lt;code class=\&quot;objective-c\&quot;&gt; - (void)customTraits() {     //Specified UIPageControl with the ’ajustable’ trait.     pageControl.accessibilityTraits = UIAccessibilityTraitAdjustable;          //Added header.       defaultHeaderViewCell.accessibilityTraits = UIAccessibilityTraitHeader; } &lt;/code&gt;&lt;/pre&gt;&lt;pre&gt;&lt;code class=\&quot;swift\&quot;&gt; func customTraits() {     //Specified UIPageControl with the ’ajustable’ trait.     pageControl.accessibilityTraits = .adjustable          //Added header.       defaultHeaderViewCell.accessibilityTraits = .header } &lt;/code&gt;&lt;/pre&gt;  "
});

documentTitles["dev-ios.html#basic-operations"] = "Basic operations";
index.add({
    url: "dev-ios.html#basic-operations",
    title: "Basic operations",    
    body: "### Basic operations This attribute is actually a `bitmask` in which each element has its own value. &lt;/br&gt;&lt;img alt=\&quot;\&quot; style=\&quot;max-width: 600px; height: auto; \&quot; src=\&quot;./images/iOSdev/Traits.png\&quot; /&gt; &lt;/br&gt;It's then possible to add and remove some `traits` after having checked their existence in the bitmask for instance.  &lt;pre&gt;&lt;code class=\&quot;objective-c\&quot;&gt; - (void)changeTraits {      //Dedicated trait set with no other option.     onePageButton.accessibilityTraits = UIAccessibilityTraitButton | UIAccessibilityTraitLink;          //Added traits to the existing ones.     pageControl.accessibilityTraits |= UIAccessibilityTraitHeader; //Only one trait.     pageControl.accessibilityTraits |= UIAccessibilityTraitButton + UIAccessibilityTraitLink; //Many traits.          //Remove a trait.     onePageButton.accessibilityTraits &amp;= ~UIAccessibilityTraitLink;          //Check out the bitmask trait existence.     if ((pageControl.accessibilityTraits &amp; UIAccessibilityTraitHeader) != 0) {         // Do the job if '.header' is one of the traits...     } } &lt;/code&gt;&lt;/pre&gt;&lt;pre&gt;&lt;code class=\&quot;swift\&quot;&gt; func changeTraits() {              //Dedicated trait set with no other option.     onePageButton.accessibilityTraits = [.button, .link]              //Added traits to the existing ones.     pageControl.accessibilityTraits.insert(.header) //Only one trait.     pageControl.accessibilityTraits.formUnion([.button, .link]) //Many traits.              //Remove a trait.     onePageButton.accessibilityTraits.remove(.link)              //Check out the bitmask trait existence.     if (pageControl.accessibilityTraits.rawValue &amp; UIAccessibilityTraits.header.rawValue == UIAccessibilityTraits.header.rawValue) {         // Do the job if '.header' is one of the traits...     } } &lt;/code&gt;&lt;/pre&gt; "
});
...
index.add({
    url: "dev-ios.html#description",
    title: "Description",    
    body: "### Description Using VoiceOver for reading date, time and numbers may become rapidly a headache if some steps fade into obscurity. &lt;/br&gt;&lt;/br&gt; "
});
...
index.add({
    url: "dev-ios.html#example",
    title: "Example",    
    body: "### Example &lt;pre&gt;&lt;code class=\&quot;objective-c\&quot;&gt; UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification,                                  @\&quot;This is a VoiceOver message.\&quot;); &lt;/code&gt;&lt;/pre&gt;&lt;pre&gt;&lt;code class=\&quot;swift\&quot;&gt; UIAccessibility.post(notification: .announcement,                      argument: \&quot;This is a VoiceOver message.\&quot;) &lt;/code&gt;&lt;/pre&gt; "
});
...
index.add({
    url: "dev-ios.html#example",
    title: "Example",    
    body: "### Example &lt;pre&gt;&lt;code class=\&quot;objective-c\&quot;&gt; - (IBAction)tapHere:(UIButton *)sender {          myLabel.accessibilityLanguage = @\&quot;fr\&quot;;     myLabel.accessibilityLabel = @\&quot;Ceci est un nouveau label. Merci.\&quot;;     UIAccessibilityPostNotification(UIAccessibilityLayoutChangedNotification, myLabel); } &lt;/code&gt;&lt;/pre&gt;&lt;pre&gt;&lt;code class=\&quot;swift\&quot;&gt; @IBAction func tapHere(_ sender: UIButton) {              myLabel.accessibilityLanguage = \&quot;fr\&quot;     myLabel.accessibilityLabel = \&quot;Ceci est un nouveau label. Merci.\&quot;     UIAccessibility.post(notification: UIAccessibility.Notification.layoutChanged,                          argument: myLabel) } &lt;/code&gt;&lt;/pre&gt; "
});
...
documentTitles["dev-ios.html#hide-elements"] = "Hide elements";
index.add({
    url: "dev-ios.html#hide-elements",
    title: "Hide elements",    
    body: "## Hide elements "
});
...
index.add({
    url: "dev-ios.html#description",
    title: "Description",    
    body: "### Description It is possible via an accessibility attribute to hide elements from accessibility tools (e.g. VoiceOver). By extension, it is possible to force some elements to be visible to accessibility tools.    - **isAccessibilityElement**&amp;nbsp;: boolean to specify that an element is visible or not to the Accessibility &lt;abbr&gt;API&lt;/abbr&gt; (VoiceOver or other). - **accessibilityElementsHidden**&amp;nbsp;: boolean to indicate that the children elements of the target element are visible or not to the Accessibility &lt;abbr&gt;API&lt;/abbr&gt;. - **accessibilityViewIsModal**&amp;nbsp;: boolean that can make visible or not the sibling elements of the target element to the Accessibility &lt;abbr&gt;API&lt;/abbr&gt;. &lt;/br&gt;A [theoretical explanation](./dev-ios-wwdc-18230.html#accessibilityViewIsModal) and a [practical example](./dev-ios-wwdc-18230.html#DemoModalView) are provided in a video detailed in the WWDC part.    The `accessibilityElement` attribute is available via the interface builder but can also be used directly through the code. The other two attributes are available only through the code. "
});
...
index.add({
    url: "dev-ios.html#example",
    title: "Example",    
    body: "### Example A red square will be drawn and contain two other squares (blue and yellow) in order to apply the attributes defined hereabove.  &lt;img alt=\&quot;\&quot; style=\&quot;max-width: 500px; height: auto; \&quot; src=\&quot;./images/iOSdev/MasquerDesElements_1.png\&quot; /&gt; &lt;pre&gt;&lt;code class=\&quot;objective-c\&quot;&gt; - (void)viewDidAppear:(BOOL)animated {     [super viewDidAppear:animated];          //Creation of an element inside which 2 other children elements will be inserted.     CGRect redParentViewRect = CGRectMake(100.0, 100.0, 40.0, 40.0);     UIView * myRedParentView = [[UIView alloc]initWithFrame:redParentViewRect];     myRedParentView.backgroundColor = [UIColor redColor];          [self.view addSubview:myRedParentView];          //The target element musn't be accessible so as to be considered as a container to its children elements.     //If this attribute is 'YES', the target element will be the only one accessible element.     myRedParentView.isAccessibilityElement = NO;          //The elements contained in the target element won't be accessible even if they're defined as such.     //If this attribute is 'NO' and the previous one is 'NO', only the children elements will be accessible.     myRedParentView.accessibilityElementsHidden = NO;          [self createViewWithColor:[UIColor yellowColor]                         inside:myRedParentView];     [self createViewWithColor:[UIColor blueColor]                         inside:myRedParentView]; }  - (void)createViewWithColor:(UIColor*)color                      inside:(UIView*)parentView {          float delta = (color == [UIColor yellowColor]) ? 0.0 : 20.0;          CGRect rect = CGRectMake(10.0 + delta, 10.0 + delta, 10.0, 10.0);     UIView * theView = [[UIView alloc]initWithFrame:rect];     theView.backgroundColor = color;          [parentView addSubview:theView];          theView.isAccessibilityElement = YES; } &lt;/code&gt;&lt;/pre&gt;&lt;pre&gt;&lt;code class=\&quot;swift\&quot;&gt; override func viewDidAppear(_ animated: Bool) {         super.viewDidAppear(animated)                  //Creation of an element inside which 2 other children elements will be inserted.         let redParentViewRect = CGRect.init(x: 100.0,                                             y: 100.0,                                             width: 40.0,                                             height: 40.0)         let myParentView = UIView.init(frame: parentViewRect)         myRedParentView.backgroundColor = .red                  self.view.addSubview(myRedParentView)                  //The target element musn't be accessible so as to be considered as a container to its children elements.         //If this attribute is 'true', the target element will be the only one accessible element.         myRedParentView.isAccessibilityElement = true                  //The elements contained in the target element won't be accessible even if they're defined as such.         //If this attribute is 'false' and the previous one is 'false', only the children elements will be accessible.         myRedParentView.accessibilityElementsHidden = false                  self.createViewWithColor(.yellow, inside: myRedParentView)         self.createViewWithColor(.blue, inside: myRedParentView)     }          func createViewWithColor(_ color:UIColor, inside parentView:UIView) {                  let delta:CGFloat = ((color == .yellow) ? 0.0 : 20.0)         let rect = CGRect.init(x: 10.0 + delta,                                y: 10.0 + delta,                                width: 10.0,                                height: 10.0)                  let theView = UIView.init(frame: rect)         theView.backgroundColor = color                  parentView.addSubview(theView)                  theView.isAccessibilityElement = true     } &lt;/code&gt;&lt;/pre&gt; "
});
...
index.add({
    url: "dev-ios.html#links",
    title: "Links",    
    body: "### Links - [`accessibilityActivate`](https://developer.apple.com/documentation/objectivec/nsobject/1615165-accessibilityactivate) - [`shouldGroupAccessibilityChildren`](https://developer.apple.com/documentation/objectivec/nsobject/1615143-shouldgroupaccessibilitychildren) &lt;/br&gt;&lt;/br&gt; "
});
...
index.add({
    url: "dev-ios.html#description",
    title: "Description",    
    body: "### Description Redefining the VoiceOver reading order is done using the **UIAccessibilityContainer** protocol. &lt;/br&gt;The idea is to have a table of elements that defines the reading order of the elements. &lt;/br&gt;It is often very useful to use the **shouldGroupAccessibilityElement** attribute so we have a precise order but only for a part of the view *(the rest of it will be read using the native order provided by VoiceOver)*. "
});
...
index.add({
    url: "dev-ios.html#links",
    title: "Links",    
    body: "### Links - [`UIAccessibilityContainer`](https://developer.apple.com/documentation/uikit/accessibility/uiaccessibilitycontainer?language=objc) - [`shouldGroupAccessibilityChildren`](https://developer.apple.com/documentation/objectivec/nsobject/1615143-shouldgroupaccessibilitychildren) &lt;/br&gt;&lt;/br&gt; "
});
...
index.add({
    url: "dev-ios.html#link",
    title: "Link",    
    body: "### Link - [`UIAccessibilityFocus`](https://developer.apple.com/documentation/uikit/accessibility/uiaccessibilityfocus) &lt;/br&gt;&lt;/br&gt; "
});
...
index.add({
    url: "dev-ios.html#description",
    title: "Description",    
    body: "### Description In the case of dynamically modified element or component not inheriting from `UIView`, it is possible to modify the focus area of accessibility of this element, i.e. the area &lt;span lang=\&quot;en\&quot;&gt;VoiceOver&lt;/span&gt; highlights when focusing an element.  - **accessibilityFrame**&amp;nbsp;: sets the area via a rectangle (`CGRect`). &lt;/br&gt;Usually, for an element inheriting from `UIView`, this area is the «&amp;nbsp;visible&amp;nbsp;» part of the view. - **accessibilityPath**&amp;nbsp;: equivalent to `accessibilityFrame` but sets the area via Bezier curves. &lt;a name=\&quot;AccessibilityActivationPoint\&quot;&gt;&lt;/a&gt; - **accessibilityActivationPoint**&amp;nbsp;: defines a contact point inside the `frame` whose action will be fired by a double-tap element activation. &lt;/br&gt;The default value is the midpoint of the `frame` but it can be redefine anywhere inside. &lt;/br&gt;A classical use case could be an easy activation inside a [regroupment of elements](#ActivationPointExemple) for instance. &lt;/br&gt;&lt;img alt=\&quot;\&quot; style=\&quot;max-width: 350px; height: auto; \&quot; src=\&quot;./images/iOSdev/ModifierLaZoneDeFocus_2.png\&quot; /&gt; &lt;/br&gt;By keeping this default value, one might unwillingly activate the element in the middle of the frame only by activating the created regroupment.  "
});
...
index.add({
    url: "dev-ios.html#links",
    title: "Links",    
    body: "### Links - [`accessibilityFrame`](https://developer.apple.com/documentation/uikit/uiaccessibilityelement/1619579-accessibilityframe) - [`accessibilityPath`](https://developer.apple.com/documentation/objectivec/nsobject/1615159-accessibilitypath) - [`accessibilityActivationPoint`](https://developer.apple.com/documentation/objectivec/nsobject/1615179-accessibilityactivationpoint) &lt;/br&gt;&lt;/br&gt; "
});
...
index.add({
    url: "dev-ios.html#links",
    title: "Links",    
    body: "### Links - [Dynamic Type &amp; Text Styles](https://developer.apple.com/design/human-interface-guidelines/ios/visual-design/typography/) - [`UIContentSizeCategoryDidChange`](https://developer.apple.com/documentation/foundation/nsnotification.name/1622948-uicontentsizecategorydidchange) - [`adjustsFontForContentSizeCategory`](https://developer.apple.com/documentation/uikit/uicontentsizecategoryadjusting/1771731-adjustsfontforcontentsizecategor?language=objc) &lt;/br&gt;&lt;/br&gt; "
});

documentTitles["dev-ios.html#truncation-hyphen"] = "Truncation hyphen";
index.add({
    url: "dev-ios.html#truncation-hyphen",
    title: "Truncation hyphen",    
    body: "## Truncation hyphen "
});
...
index.add({
    url: "dev-ios.html#description",
    title: "Description",    
    body: "### Description The `Dynamic Type` feature introduced in the previous section may come along with a word truncation according to the magnifying defined in the settings. &lt;/br&gt;Unfortunately, the iOS system doesn't handle natively this point that can be implemented only by programing to get an appreciated visual depiction. &lt;/br&gt;&lt;img alt=\&quot;\&quot; style=\&quot;max-width: 700px; height: auto; \&quot; src=\&quot;./images/iOSdev/Troncature.png\&quot; /&gt; &lt;/br&gt;The rationale behind is the use of a `NSMutableAttributedString` with a `NSMutableParagraphStyle` type property as exposed hereunder : &lt;pre&gt;&lt;code class=\&quot;objective-c\&quot;&gt; @interface TruncationHyphen () {     __weak IBOutlet UILabel * myLabel; } @end   @implementation TruncationHyphen  - (void)viewDidLoad {     [super viewDidLoad];          NSString * myString = @\&quot;floccinaucinihilipilification\&quot;;     NSMutableParagraphStyle * paraph = [[NSMutableParagraphStyle alloc] init];          paraph.alignment = NSTextAlignmentJustified;     paraph.hyphenationFactor = 1.0;          UIFont * myFont = [UIFont fontWithName:@\&quot;HoeflerText-Black\&quot; size:18.0];     UIFont * myTextFont = [[UIFontMetrics metricsForTextStyle:UIFontTextStyleTitle1] scaledFontForFont:myFont];          NSDictionary * attributesDictionary = @{NSFontAttributeName:myTextFont};     NSMutableAttributedString * myText = [[NSMutableAttributedString alloc]initWithString:myString                                                                                 attributes:attributesDictionary];          [myText addAttribute:NSParagraphStyleAttributeName                    value:paraph                    range:NSMakeRange(0, 1)];          myLabel.attributedText = myText; } @end &lt;/code&gt;&lt;/pre&gt;&lt;pre&gt;&lt;code class=\&quot;swift\&quot;&gt; class TruncationHyphen: UIViewController {      @IBOutlet weak var myLabel: UILabel!          override func viewDidLoad() {         super.viewDidLoad()                  let myString = \&quot;floccinaucinihilipilification\&quot;                  let paraph = NSMutableParagraphStyle()         paraph.alignment = .justified         paraph.hyphenationFactor = 1.0                  let myTextFont = UIFontMetrics(forTextStyle: .title1).scaledFont(for:UIFont(name:\&quot;HoeflerText-Black\&quot;, size:18)!)                  let myText = NSMutableAttributedString(string:myString,                                                attributes: [.font: myTextFont])                  myText.addAttribute(.paragraphStyle,                             value: paraph,                             range: NSMakeRange(0,1))          myLabel.attributedText = myText     } } &lt;/code&gt;&lt;/pre&gt;  &lt;/br&gt;&lt;/br&gt; "
});
...
index.add({
    url: "dev-ios.html#link",
    title: "Link",    
    body: "### Link - [`adjustsImageSizeForAccessibilityContentSizeCategory`](https://developer.apple.com/documentation/uikit/uiaccessibilitycontentsizecategoryimageadjusting/2890929-adjustsimagesizeforaccessibility) &lt;/br&gt;&lt;/br&gt; "
});
...
index.add({
    url: "dev-ios.html#link",
    title: "Link",    
    body: "### Link - [`UIAccessibilityTraitAdjustable`](https://developer.apple.com/documentation/uikit/uiaccessibilitytraitadjustable) &lt;/br&gt;&lt;/br&gt; "
});
...
index.add({
    url: "dev-ios.html#links",
    title: "Links",    
    body: "### Links - [`accessibilityCustomActions`](https://developer.apple.com/documentation/objectivec/nsobject/1615150-accessibilitycustomactions) - [`UIAccessibilityCustomAction`](https://developer.apple.com/documentation/uikit/uiaccessibilitycustomaction) &lt;/br&gt;&lt;/br&gt; "
});
...
index.add({
    url: "dev-ios.html#links",
    title: "Links",    
    body: "### Links - [`UIAccessibilityCustomRotor`](https://developer.apple.com/documentation/uikit/uiaccessibilitycustomrotor) - [`UIAccessibilityCustomRotorItemResult`](https://developer.apple.com/documentation/uikit/uiaccessibilitycustomrotoritemresult) - [`UIAccessibilityCustomRotorSearchPredicate`](https://developer.apple.com/documentation/uikit/uiaccessibilitycustomrotorsearchpredicate) &lt;/br&gt;&lt;/br&gt; "
});

documentTitles["dev-ios.html#accessibility-options"] = "Accessibility options";
index.add({
    url: "dev-ios.html#accessibility-options",
    title: "Accessibility options",    
    body: "## Accessibility options "
});

documentTitles["dev-ios.html#states"] = "States";
index.add({
    url: "dev-ios.html#states",
    title: "States",    
    body: "### States On iOS, it is possible to check the accessibility options state.  &lt;/br&gt;Is VoiceOver activated? Is the audio-mono mode activated? Several methods that are part of the `UIKit` framework can help you to check with that. &lt;/br&gt;The most useful method is **UIAccessibilityIsVoiceOverRunning** which allows to know whether VoiceOver is activated. &lt;/br&gt;&lt;/br&gt;Some other methods are deeply explained in a WWDC 2018 video *(Deliver en exceptional accessibility experience)* whose content is perfectly detailed in the [iOS WWDC section](./dev-ios-wwdc-18230.html) of this site.&lt;/br&gt;&lt;/br&gt; "
});
...
index.add({
    url: "dev-ios.html#example",
    title: "Example",    
    body: "### Example &lt;pre&gt;&lt;code class=\&quot;objective-c\&quot;&gt;     BOOL isVoiveOverRunning = (UIAccessibilityIsVoiceOverRunning() ? 1 : 0);     BOOL isSwitchControlRunning = (UIAccessibilityIsSwitchControlRunning() ? 1 : 0);          NSLog(@\&quot;VoiceOver is %d and SwitchControl is %d.\&quot;, isVoiveOverRunning, isSwitchControlRunning); &lt;/code&gt;&lt;/pre&gt;&lt;pre&gt;&lt;code class=\&quot;swift\&quot;&gt;     let isVoiceOverRunning = (UIAccessibility.isVoiceOverRunning ? 1 : 0)     let isSwitchControlRunning = (UIAccessibility.isSwitchControlRunning ? 1 : 0)              print(\&quot;VoiceOver is \(isVoiceOverRunning) and SwichControl is \(isSwitchControlRunning).\&quot;) &lt;/code&gt;&lt;/pre&gt; "
});

documentTitles["dev-ios.html#events"] = "Events";
index.add({
    url: "dev-ios.html#events",
    title: "Events",    
    body: "### Events iOS sends many accessibility events when accessibility options have changed. &lt;/br&gt;For example, if VoiceOver is deactivated, the running applications will receive the `UIAccessibilityVoiceOverStatusDidChangeNotification` event. &lt;/br&gt;This is very useful when used simultaneously with `UIAccessibilityIsVoiceOverRunning`.  Let's say the application behaves differently when VoiceOver is turned on. &lt;/br&gt;What happens if VoiceOver is disabled ? This is exactly the use case when the system events can be used. &lt;/br&gt;By listening to these events, it is possible to dynamically change how the application behaves.&lt;/br&gt;&lt;/br&gt; "
});
...
index.add({
    url: "dev-ios.html#links",
    title: "Links",    
    body: "### Links - [Accessibility options](./criteria-ios.html#accessibility-options) *(iOS conception)*  All accessibility &lt;a href=\&quot;https://developer.apple.com/documentation/uikit/accessibility/notification_names?language=objc\&quot;&gt;events&lt;/a&gt; and &lt;a href=\&quot;https://developer.apple.com/documentation/uikit/accessibility?language=objc\&quot;&gt;options&lt;/a&gt; are available on the official documentation from Apple. &lt;/br&gt;&lt;img alt=\&quot;\&quot; style=\&quot;max-width: 1000px; height: auto; \&quot; src=\&quot;./images/iOSdev/OptionsA11Y.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt; "
});

documentTitles["dev-ios.html#speech-synthesis"] = "Speech synthesis";
index.add({
    url: "dev-ios.html#speech-synthesis",
    title: "Speech synthesis",    
    body: "## Speech synthesis "
});
...
index.add({
    url: "dev-ios.html#description",
    title: "Description",    
    body: "### Description Many [use cases](./dev-ios-wwdc-18236.html#Uses) are good candidates to use the speech synthesis and they aren't necessary all part of accessibility. &lt;/br&gt;However, in that perspective, it's important to note that this **feature doesn't replace VoiceOver** but could be a good complement to the screen reader implementation *(the speech overlaps the screen reader voice)*. "
});

documentTitles["dev-ios.html#details"] = "Details";
index.add({
    url: "dev-ios.html#details",
    title: "Details",    
    body: "### Details Few elements are mandatory to create a speech synthesis on the fly: - **The text**: `AVSpeechUtterance` instance with a `voice` property that's `AVSpeechSynthesisVoice` typed. - **The synthesizer**: `AVSpeechSynthesizer` instance that handles the incoming text with an events control thanks to the `AVSpeechSynthesizerDelegate` protocol. &lt;/br&gt;&lt;/br&gt;&lt;img alt=\&quot;\&quot; style=\&quot;max-width: 800px; height: auto; \&quot; src=\&quot;./images/iOSdev/SpeechSynthesizer.png\&quot; /&gt; "
});
...
index.add({
    url: "dev-ios.html#example",
    title: "Example",    
    body: "### Example To be sure that a bunch of `AVSpeechUtterance` instances is entirely vocalized, it's [essential](./dev-ios-wwdc-18236.html#Basics) to retain the `AVSpeechSynthesizer` instance until the speech is done. &lt;/br&gt;&lt;/br&gt;The following example will define the speech rate and the voice pitch/volume for each utterance while: - Highlighting the vocalized word thanks to the `AVSpeechSynthesizerDelegate` protocol. - Pausing and resuming from where the speech stopped thanks to some `AVSpeechSynthesizer` instance methods.  &lt;pre&gt;&lt;code class=\&quot;objective-c\&quot;&gt; @interface SpeechSynthesis()  &lt;AVSpeechSynthesizerDelegate&gt; {      NSMutableArray * playerQueue;     AVSpeechSynthesizer * synthesizer;     __weak IBOutlet UILabel * textLabel; } @end  NS_ASSUME_NONNULL_BEGIN @implementation SpeechSynthesis  - (void)viewDidLoad {     [super viewDidLoad];          playerQueue = [[NSMutableArray alloc] init];     synthesizer = [[AVSpeechSynthesizer alloc] init]; }  - (void)viewDidAppear:(BOOL)animated {     [super viewDidAppear:animated];          for (int i = 1 ; i &lt; 11 ; i++) {               NSString * stringNbPrefix = @\&quot;Sentence number \&quot;;         NSString * stringNbSuffix = @\&quot; of the speech synthesizer.\&quot;;         NSString * stringNb = [NSString stringWithFormat:@\&quot;%@%i%@\&quot;, stringNbPrefix, i, stringNbSuffix];                  AVSpeechUtterance * utterance = [[AVSpeechUtterance alloc] initWithString:stringNb];         utterance.rate = AVSpeechUtteranceDefaultSpeechRate;         utterance.pitchMultiplier = 1.0;         utterance.volume = 1.0;                  [playerQueue addObject:utterance];     }          synthesizer.delegate = self;          for (AVSpeechUtterance * utterance in playerQueue) {         [synthesizer speakUtterance:utterance];     } }  //AVSpeechSynthesizerDelegate protocol method to highlight the vocalized word. - (void)speechSynthesizer:(AVSpeechSynthesizer *)synthesizer willSpeakRangeOfSpeechString:(NSRange)characterRange                 utterance:(AVSpeechUtterance *)utterance {          NSMutableAttributedString * attributedString = [[NSMutableAttributedString alloc] initWithString:utterance.speechString];          [attributedString addAttribute:NSFontAttributeName                              value:[UIFont systemFontOfSize:19.0]                              range:characterRange];          NSAttributedString * subString = [attributedString attributedSubstringFromRange:characterRange];     textLabel.attributedText = attributedString;          NSString * output = [NSString stringWithFormat:@\&quot;%@%@\&quot;, @\&quot;word : \&quot;, subString.string];     NSLog(@\&quot;%@\&quot;, output); }  - (IBAction)pauseButton:(UIButton *)sender {          if (synthesizer.isSpeaking == TRUE) {         if ([synthesizer pauseSpeakingAtBoundary:AVSpeechBoundaryImmediate] == TRUE) {             NSLog(@\&quot;PAUSE\&quot;);         } else {             NSLog(@\&quot;P.R.O.B.L.E.M. when pausing.\&quot;);         }     } }  - (IBAction)resumeButton:(UIButton *)sender {          if (synthesizer.isPaused == TRUE) {         if ([synthesizer continueSpeaking] == TRUE) {             NSLog(@\&quot;RESUME\&quot;);         } else {             NSLog(@\&quot;P.R.O.B.L.E.M. when resuming.\&quot;);         }     } } @end &lt;/code&gt;&lt;/pre&gt;&lt;pre&gt;&lt;code class=\&quot;swift\&quot;&gt; class SpeechSynthesis: UIViewController, AVSpeechSynthesizerDelegate {          @IBOutlet weak var textLabel: UILabel!          var synthesizer = AVSpeechSynthesizer()     var playQueue = [AVSpeechUtterance]()               override func viewDidAppear(_ animated: Bool) {         super.viewDidAppear(animated)                  for i in 1...10 {                          let stringNb = \&quot;Sentence number \&quot; + String(i) + \&quot; of the speech synthesizer.\&quot;                          let utterance = AVSpeechUtterance(string: stringNb)             utterance.rate = AVSpeechUtteranceDefaultSpeechRate             utterance.pitchMultiplier = 1.0             utterance.volume = 1.0                          playQueue.append(utterance)         }          synthesizer.delegate = self          for utterance in playQueue {             synthesizer.speak(utterance)         }     }          //AVSpeechSynthesizerDelegate protocol method to highlight the vocalized word.     func speechSynthesizer(_ synthesizer: AVSpeechSynthesizer,                            willSpeakRangeOfSpeechString characterRange: NSRange,                            utterance: AVSpeechUtterance) {          let attributedString = NSMutableAttributedString(string: utterance.speechString)         attributedString.addAttribute(.font,                                       value: UIFont.boldSystemFont(ofSize: 19),                                       range: characterRange)          textLabel.attributedText = attributedString          let subString = attributedString.attributedSubstring(from: characterRange)         print(\&quot;word : \(subString.string)\&quot;)     }               @IBAction func pauseAction(_ sender: UIButton) {              if (synthesizer.isSpeaking == true) {             if (synthesizer.pauseSpeaking(at: .immediate) == true) {                 print(\&quot;PAUSE\&quot;)             } else {                 print(\&quot;P.R.O.B.L.E.M. when pausing.\&quot;)             }         }     }               @IBAction func resumeAction(_ sender: UIButton) {               if (synthesizer.isPaused == true) {             if (synthesizer.continueSpeaking() == true) {                 print(\&quot;RESUME\&quot;)             } else {                 print(\&quot;P.R.O.B.L.E.M. when resuming.\&quot;)             }         }     } } &lt;/code&gt;&lt;/pre&gt;  When a particular spelling is intended, phonetics is highly recommended to get the desired purpose.  &lt;pre&gt;&lt;code class=\&quot;objective-c\&quot;&gt;     NSMutableAttributedString * attrStr = [[NSMutableAttributedString alloc] initWithString:@\&quot;blablabla\&quot;                                                                               attributes:@{AVSpeechSynthesisIPANotationAttribute:@\&quot;ˈma͡ɪ.ˈa͡ɪ.ˈfʌ.ˈniz.ˈgɻe͡ɪt\&quot;}];          AVSpeechUtterance * utterance = [[AVSpeechUtterance alloc] initWithAttributedString:attrStr];          AVSpeechSynthesizer * synthesizer = [[AVSpeechSynthesizer alloc] init];     [synthesizer speakUtterance:utterance]; &lt;/code&gt;&lt;/pre&gt;&lt;pre&gt;&lt;code class=\&quot;swift\&quot;&gt;         let pronunciationKey = NSAttributedString.Key(rawValue: AVSpeechSynthesisIPANotationAttribute)                  let attrStr = NSMutableAttributedString(string: \&quot;blablabla\&quot;,                                                 attributes: [pronunciationKey: \&quot;ˈma͡ɪ.ˈa͡ɪ.ˈfʌ.ˈniz.ˈgɻe͡ɪt\&quot;])          let utterance = AVSpeechUtterance(attributedString: attrStr)          let synthesizer = AVSpeechSynthesizer()         synthesizer.speak(utterance) &lt;/code&gt;&lt;/pre&gt;  &lt;/br&gt;Generating phonetics may be done in the device settings. &lt;/br&gt;&lt;img alt=\&quot;\&quot; style=\&quot;max-width: 1100px; height: auto; \&quot; src=\&quot;./images/iOSdev/SpeechSynthesizerEx_1.png\&quot; /&gt; &lt;/br&gt;Once the menu `General` - ` Accessibility` - `Speech` - `Pronunciations` is reached... &lt;/br&gt;&lt;img alt=\&quot;\&quot; style=\&quot;max-width: 1100px; height: auto; \&quot; src=\&quot;./images/iOSdev/SpeechSynthesizerEx_2.png\&quot; /&gt;&lt;/br&gt; 1. Select the '**+**' icon to add a new phonetic element. 2. Name this new element in order to quickly find it later on. 3. Tap the **microphone** icon. 4. Vocalize an entire sentence or a single word. 5. Listen to the different system proposals. 6. Validate your choice with the '**OK**' button or cancel to start over. 7. Tap the back button to confirm the new created phonetic element. 8. Find all the generated elements in the `Pronunciations` page.  &lt;img alt=\&quot;\&quot; style=\&quot;max-width: 1100px; height: auto; \&quot; src=\&quot;./images/iOSdev/SpeechSynthesizerEx_3.png\&quot;/&gt; &lt;/br&gt;To get the phonetic expression inside the code, pass it through the mobile `Notes` application to be synchronized with the iCloud one from which a copy-paste becomes easy as a pie. &lt;/br&gt;&lt;/br&gt;All the speech synthesizer functionalities are introduced in a [WWDC 2018 video](./dev-ios-wwdc-18236.html) that's perfectly summarized in the WWDC section of this site.&lt;/br&gt; "
});
...
index.add({
    url: "dev-ios.html#links",
    title: "Links",    
    body: "### Links - [AVSpeechSynthesisVoice](https://developer.apple.com/documentation/avfoundation/avspeechsynthesisvoice) - [AVSpeechSynthesizer](https://developer.apple.com/documentation/avfoundation/avspeechsynthesizer) - [AVSpeechSynthesizerDelegate](https://developer.apple.com/documentation/avfoundation/avspeechsynthesizerdelegate) - [AVSpeechUtterance](https://developer.apple.com/documentation/avfoundation/avspeechutterance)  "
});
...
index.add({
    url: "dev-ios.html#link",
    title: "Link",    
    body: "### Link - [`accessibilityNavigationStyle`](https://developer.apple.com/documentation/objectivec/nsobject/1615200-accessibilitynavigationstyle)&lt;/br&gt;&lt;/br&gt; "
});

documentTitles["dev-ios.html#vocalized-application-name"] = "Vocalized application name";
index.add({
    url: "dev-ios.html#vocalized-application-name",
    title: "Vocalized application name",    
    body: "## Vocalized application name "
});
...
index.add({
    url: "dev-ios.html#description",
    title: "Description",    
    body: "### Description The same result as the [VoiceOver gesture](./voiceover.html#CustomLabel) to set a custom label can be reached by code. &lt;/br&gt;The rationale behind is to render a better vocalisation for an application name that could be very obscure according to its written abbreviation. &lt;/br&gt;&lt;/br&gt;**CFBundleSpokenName** is the property list key that vocally replaces an application name and might take many different translations depending on the foreign languages. &lt;/br&gt;&lt;img alt=\&quot;\&quot; style=\&quot;max-width: 750px; height: auto; \&quot; src=\&quot;./images/iOSdev/AppName_1.png\&quot; /&gt; &lt;/br&gt;In the end, we go from a weird to an understandable vocalized name that is defined upstream with no user modifications. &lt;/br&gt;&lt;img alt=\&quot;\&quot; style=\&quot;max-width: 600px; height: auto; \&quot; src=\&quot;./images/iOSdev/AppName_2.png\&quot; /&gt; "
});
...
index.add({
    url: "dev-ios.html#link",
    title: "Link",    
    body: "### Link - [`CFBundleSpokenName`](https://developer.apple.com/documentation/bundleresources/information_property_list/cfbundlespokenname)&lt;/br&gt;&lt;/br&gt; &lt;!--  This file is part of a11y-guidelines | Our vision of mobile &amp; web accessibility guidelines and best practices, with valid/invalid examples.  Copyright (C) 2016  Orange SA  See the Creative Commons Legal Code Attribution-ShareAlike 3.0 Unported License for more details (LICENSE file). --&gt;"
});
...
index.add({
    ...
    body: "# WWDC : World Wide Developers Conference  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;iOS\&quot;,\&quot;url\&quot;:\&quot;mobile-ios.html\&quot;},                    {\&quot;label\&quot;:\&quot;WWDC\&quot;}]);     addSubMenu([         {\&quot;label\&quot;:\&quot;Design criteria\&quot;,\&quot;url\&quot;:\&quot;criteria-ios.html\&quot;},          {\&quot;label\&quot;:\&quot;Developers guide\&quot;,\&quot;url\&quot;:\&quot;dev-ios.html\&quot;},         {\&quot;label\&quot;:\&quot;VoiceOver\&quot;,\&quot;url\&quot;:\&quot;voiceover.html\&quot;},         {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;, \&quot;expanded\&quot;: true},         {\&quot;label\&quot;:\&quot;Tests\&quot;,\&quot;url\&quot;:\&quot;criteria-ios-test.html\&quot;}     ]);         });&lt;/script&gt;  &lt;span data-menuitem=\&quot;mobile-ios\&quot;&gt;&lt;/span&gt;  This section regroups [presentations at the WWDC](https://developer.apple.com/videos/) dealing with accessibility. &lt;/br&gt;Each one of them is detailed with time references to their different contents. &lt;/br&gt;&lt;/br&gt;Most of the illustrations are parts of Apple presentations and are available at the `Resources` section inside the `Overview` sheet of each video. &lt;/br&gt;**The summary of each video can be reached on clicking the title or the image presentation**. &lt;/br&gt;&lt;/br&gt;  "
});

documentTitles["dev-ios-wwdc.html#2018-deliver-an-exceptional-accessibility-experiencedev-ios-wwdc-18230html"] = "[2018 - Deliver an exceptional accessibility experience](./dev-ios-wwdc-18230.html)";
index.add({
    url: "dev-ios-wwdc.html#2018-deliver-an-exceptional-accessibility-experiencedev-ios-wwdc-18230html",
    title: "[2018 - Deliver an exceptional accessibility experience](./dev-ios-wwdc-18230.html)",    
    body: "## [2018 - Deliver an exceptional accessibility experience](./dev-ios-wwdc-18230.html) This presentation is a detailed explanation of functionalities for visual impaired people leading to a very good user experience. &lt;/br&gt;A demo application will highlight these functionalities purposes so as to understand the rationale behind their implementation. &lt;/br&gt;&lt;a href=\&quot;./dev-ios-wwdc-18230.html\&quot;&gt;&lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;Access to deliver an exceptional accessibility experience.\&quot; src=\&quot;./images/iOSdev/wwdc18-230.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt;      "
});

documentTitles["dev-ios-wwdc.html#2018-avspeechsynthesizerdev-ios-wwdc-18236html"] = "[2018 - AVSpeechSynthesizer](./dev-ios-wwdc-18236.html)";
index.add({
    url: "dev-ios-wwdc.html#2018-avspeechsynthesizerdev-ios-wwdc-18236html",
    title: "[2018 - AVSpeechSynthesizer](./dev-ios-wwdc-18236.html)",    
    body: "## [2018 - AVSpeechSynthesizer](./dev-ios-wwdc-18236.html) This short video introduces the essential elements to be implemented so as to make an iOS application talk. &lt;/br&gt;&lt;a href=\&quot;./dev-ios-wwdc-18236.html\&quot;&gt;&lt;img style=\&quot;max-width: 466px; height: auto;\&quot; alt=\&quot;Access to AVSpeechSynthesizer.\&quot; src=\&quot;./images/iOSdev/wwdc18-236.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt;  "
});
...
index.add({
    ...
    body: "## [2017 - What's New in Accessibility](./dev-ios-wwdc-17215.html) Introduction of new iOS 11 accessibility features merging the user and the developer sides. &lt;/br&gt;&lt;a href=\&quot;./dev-ios-wwdc-17215.html\&quot;&gt;&lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;Access to what's new in accessibility.\&quot; src=\&quot;./images/iOSdev/wwdc17-215.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt;  "
});
...
documentTitles["dev-ios-wwdc.html#2016-whats-new-in-accessibilitydev-ios-wwdc-16202html"] = "[2016 - What's New in Accessibility](./dev-ios-wwdc-16202.html)";
index.add({
    url: "dev-ios-wwdc.html#2016-whats-new-in-accessibilitydev-ios-wwdc-16202html",
    title: "[2016 - What's New in Accessibility](./dev-ios-wwdc-16202.html)",    
    body: "## [2016 - What's New in Accessibility](./dev-ios-wwdc-16202.html) Introduction of new iOS, MacOS, tvOS and WatchOS accessibility features merging the user and the developer sides. &lt;/br&gt;&lt;a href=\&quot;./dev-ios-wwdc-16202.html\&quot;&gt;&lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;Access to what's new in accessibility\&quot; src=\&quot;./images/iOSdev/wwdc16-202.png\&quot; /&gt;      "
});
...
documentTitles["dev-ios-wwdc-16202.html#wwdc-2016-whats-new-in-accessibility"] = "WWDC 2016 : What's New in Accessibility";
index.add({
    url: "dev-ios-wwdc-16202.html#wwdc-2016-whats-new-in-accessibility",
    title: "WWDC 2016 : What's New in Accessibility",    
    body: "# WWDC 2016 : What's New in Accessibility  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;iOS\&quot;,\&quot;url\&quot;:\&quot;mobile-ios.html\&quot;},                    {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},                    {\&quot;label\&quot;:\&quot;2016 - What's New in Accessibility\&quot;}]);     addSubMenu([         {\&quot;label\&quot;:\&quot;Design criteria\&quot;,\&quot;url\&quot;:\&quot;criteria-ios.html\&quot;},          {\&quot;label\&quot;:\&quot;Developers guide\&quot;,\&quot;url\&quot;:\&quot;dev-ios.html\&quot;},         {\&quot;label\&quot;:\&quot;VoiceOver\&quot;,\&quot;url\&quot;:\&quot;voiceover.html\&quot;},         {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},         {\&quot;label\&quot;:\&quot;Tests\&quot;,\&quot;url\&quot;:\&quot;criteria-ios-test.html\&quot;}     ]);         });&lt;/script&gt;  &lt;span data-menuitem=\&quot;mobile-ios\&quot;&gt;&lt;/span&gt;   This video available on the **official Apple website** ([session 202](https://developer.apple.com/videos/play/wwdc2016/202/)) points out the new accessibility features and some reminders of good practices dealing mostly with VoiceOver. &lt;/br&gt;&lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc16-202.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt;Various contents and their video timelapse are indicated hereunder :  - **Functionalities**     - [MOTOR - Switch Control](#SwitchControl) (02:29)     - [MOTOR - Dwell Control](#DwellControl) (03:36)     - [VISION - Display adjustments](#DisplayAdjustments) (04:15)     - [VISION - Taptic time](#TapticTime) (04:53)     - [VISION - Magnifier](#Magnifier) (05:17)     - [HEARING - TTY](#SoftwareTTY) (06:51)     - [LEARNING - Enhanced typing feedback](#EnhancedTypingFeedback) (07:51) - **Programing**     - [UIAccessibilityProtocol](#UIAccessibilityProtocol) (14:19)     - [accessibilityElements](#accessibilityElements) (18:00)     - [accessibilityFrameInContainerSpace](#accessibilityFrameInContainerSpace) (19:02)     - [accessibilityCustomRotors](#accessibilityCustomRotors) (24:19)     - [tvOS header elements](#tvOS) (31:20) - **Example** : during this presentation, the hereunder solutions for VoiceOver development pitfalls are suggested thanks to a simple application that's highly recommended [to be watched](https://developer.apple.com/videos/play/wwdc2016/202/?time=698) before going further. Once implemented, these solutions give rise to an application whose VoiceOver efficiency is shown in a [live demonstration](https://developer.apple.com/videos/play/wwdc2016/202/?time=1753).     - Activate a `table view cell` [(19:58)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1198).     - Put a dynamic `label` on a button [(20:21)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1221).     - Make `CALayer` elements accessible *(used to create a graph for instance)* [(20:45)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1245).     - Understand the navigation problems on a `mapview` with VoiceOver [(23:33)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1413).     - Searching elements in a `table view` [(25:37)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1537) and in a `mapview` [(27:45)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1665) thanks to the `rotor` item.  Thereafter, the selection of a title will give rise to the video playback directly at the proper moment. &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;SwitchControl\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-16202.html#motor-switch-control-0229httpsdeveloperapplecomvideosplaywwdc2016202time149"] = "[MOTOR - Switch Control (02:29)](https://developer.apple.com/videos/play/wwdc2016/202/?time=149)";
index.add({
    url: "dev-ios-wwdc-16202.html#motor-switch-control-0229httpsdeveloperapplecomvideosplaywwdc2016202time149",
    title: "[MOTOR - Switch Control (02:29)](https://developer.apple.com/videos/play/wwdc2016/202/?time=149)",    
    body: "### [MOTOR - Switch Control (02:29)](https://developer.apple.com/videos/play/wwdc2016/202/?time=149) After a brief reminder about this iOS functionality, a specific focus is invoked in this **new tvOS feature**. &lt;/br&gt;&lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc16-202-SwitchControl.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;DwellControl\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-16202.html#motor-dwell-control-0336httpsdeveloperapplecomvideosplaywwdc2016202time216"] = "[MOTOR - Dwell Control (03:36)](https://developer.apple.com/videos/play/wwdc2016/202/?time=216)";
index.add({
    url: "dev-ios-wwdc-16202.html#motor-dwell-control-0336httpsdeveloperapplecomvideosplaywwdc2016202time216",
    title: "[MOTOR - Dwell Control (03:36)](https://developer.apple.com/videos/play/wwdc2016/202/?time=216)",    
    body: "### [MOTOR - Dwell Control (03:36)](https://developer.apple.com/videos/play/wwdc2016/202/?time=216) Connected remote devices allow a user to control their mouse. &lt;/br&gt;When the mouse dwells on a location, the Dwell Control feature displays a timer at the expiration of which an action is triggered *(new MacOS feature)*.  &lt;/br&gt;&lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc16-202-DwellControl.png\&quot; /&gt; &lt;a name=\&quot;DisplayAdjustments\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-16202.html#vision-display-adjustments-0415httpsdeveloperapplecomvideosplaywwdc2016202time255"] = "[VISION - Display adjustments (04:15)](https://developer.apple.com/videos/play/wwdc2016/202/?time=255)";
index.add({
    url: "dev-ios-wwdc-16202.html#vision-display-adjustments-0415httpsdeveloperapplecomvideosplaywwdc2016202time255",
    title: "[VISION - Display adjustments (04:15)](https://developer.apple.com/videos/play/wwdc2016/202/?time=255)",    
    body: "### [VISION - Display adjustments (04:15)](https://developer.apple.com/videos/play/wwdc2016/202/?time=255) People who are light sensitive or have color issues already use the MacOS and iOS supported features *(inverted colors...)* that are now **available for tvOS**. &lt;/br&gt;&lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;TapticTime\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-16202.html#vision-taptic-time-0453httpsdeveloperapplecomvideosplaywwdc2016202time293"] = "[VISION - Taptic time (04:53)](https://developer.apple.com/videos/play/wwdc2016/202/?time=293)";
index.add({
    url: "dev-ios-wwdc-16202.html#vision-taptic-time-0453httpsdeveloperapplecomvideosplaywwdc2016202time293",
    title: "[VISION - Taptic time (04:53)](https://developer.apple.com/videos/play/wwdc2016/202/?time=293)",    
    body: "### [VISION - Taptic time (04:53)](https://developer.apple.com/videos/play/wwdc2016/202/?time=293) Introduced in **WatchOS 3**, this new VoiceOver feature includes a **series of distinct taps** to help people tell time silently and discretely. &lt;/br&gt;&lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;Magnifier\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-16202.html#vision-magnifier-0517httpsdeveloperapplecomvideosplaywwdc2016202time317"] = "[VISION - Magnifier (05:17)](https://developer.apple.com/videos/play/wwdc2016/202/?time=317)";
index.add({
    url: "dev-ios-wwdc-16202.html#vision-magnifier-0517httpsdeveloperapplecomvideosplaywwdc2016202time317",
    title: "[VISION - Magnifier (05:17)](https://developer.apple.com/videos/play/wwdc2016/202/?time=317)",    
    body: "### [VISION - Magnifier (05:17)](https://developer.apple.com/videos/play/wwdc2016/202/?time=317) This **new iOS 10 feature** allows the device's camera to be used in order to magnify the user environment with many possible functionalities *(steadiness, zoom, color filters...)* whose efficiency is shown in a [live demonstration](https://developer.apple.com/videos/play/wwdc2016/202/?time=344). &lt;/br&gt;&lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;SoftwareTTY\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-16202.html#hearing-tty-0651httpsdeveloperapplecomvideosplaywwdc2016202time411"] = "[HEARING - TTY (06:51)](https://developer.apple.com/videos/play/wwdc2016/202/?time=411)";
index.add({
    url: "dev-ios-wwdc-16202.html#hearing-tty-0651httpsdeveloperapplecomvideosplaywwdc2016202time411",
    title: "[HEARING - TTY (06:51)](https://developer.apple.com/videos/play/wwdc2016/202/?time=411)",    
    body: "### [HEARING - TTY (06:51)](https://developer.apple.com/videos/play/wwdc2016/202/?time=411) The typewriter technology that allows to hold text conversations over standard telephone calls for someone with hearing loss is now **available for iOS**. &lt;/br&gt;This **new iOS 10 feature** is a software implementation that prevents from adding any additional TTY hardware while using this technology only with an iOS device.  &lt;/br&gt;&lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;EnhancedTypingFeedback\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-16202.html#learning-enhanced-typing-feedback-0751httpsdeveloperapplecomvideosplaywwdc2016202time471"] = "[LEARNING - Enhanced typing feedback (07:51)](https://developer.apple.com/videos/play/wwdc2016/202/?time=471)";
index.add({
    url: "dev-ios-wwdc-16202.html#learning-enhanced-typing-feedback-0751httpsdeveloperapplecomvideosplaywwdc2016202time471",
    title: "[LEARNING - Enhanced typing feedback (07:51)](https://developer.apple.com/videos/play/wwdc2016/202/?time=471)",    
    body: "### [LEARNING - Enhanced typing feedback (07:51)](https://developer.apple.com/videos/play/wwdc2016/202/?time=471) Besides the improvements for `Speech Selection` and `Speech Screen` in the `Accessibility - Speech` part, an audio typing feedback has also been implemented. &lt;/br&gt;This **new iOS 10 feature** helps people with dyslexia to catch and prevent mistakes in their writings, highlighted by a [live demonstration](https://developer.apple.com/videos/play/wwdc2016/202/?time=496). &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;UIAccessibilityProtocol\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-16202.html#uiaccessibilityprotocol-1419httpsdeveloperapplecomvideosplaywwdc2016202time859"] = "[UIAccessibilityProtocol (14:19)](https://developer.apple.com/videos/play/wwdc2016/202/?time=859)";
index.add({
    url: "dev-ios-wwdc-16202.html#uiaccessibilityprotocol-1419httpsdeveloperapplecomvideosplaywwdc2016202time859",
    title: "[UIAccessibilityProtocol (14:19)](https://developer.apple.com/videos/play/wwdc2016/202/?time=859)",    
    body: "### [UIAccessibilityProtocol (14:19)](https://developer.apple.com/videos/play/wwdc2016/202/?time=859) Reminder on the `UIAccessibility` informal protocol fundamentals that will be used during the presentation.  &lt;/br&gt;&lt;img style=\&quot;max-width: 550px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc16-202-UIAccessibilityProtocol.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;accessibilityElements\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-16202.html#accessibilityelements-1800httpsdeveloperapplecomvideosplaywwdc2016202time1080"] = "[accessibilityElements (18:00)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1080)";
index.add({
    url: "dev-ios-wwdc-16202.html#accessibilityelements-1800httpsdeveloperapplecomvideosplaywwdc2016202time1080",
    title: "[accessibilityElements (18:00)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1080)",    
    body: "### [accessibilityElements (18:00)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1080) The implementation and the purpose of this element are explained and introduced inside the demo application.  &lt;/br&gt;&lt;img style=\&quot;max-width: 575px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc16-202-accessibilityElements.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;accessibilityFrameInContainerSpace\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-16202.html#accessibilityframeincontainerspace-1902httpsdeveloperapplecomvideosplaywwdc2016202time1142"] = "[accessibilityFrameInContainerSpace (19:02)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1142)";
index.add({
    url: "dev-ios-wwdc-16202.html#accessibilityframeincontainerspace-1902httpsdeveloperapplecomvideosplaywwdc2016202time1142",
    title: "[accessibilityFrameInContainerSpace (19:02)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1142)",    
    body: "### [accessibilityFrameInContainerSpace (19:02)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1142) This **new iOS 10 feature** allows the automatic handling of the accessible element coordinates inside its `container`. &lt;/br&gt;&lt;img style=\&quot;max-width: 575px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc16-202-accessibilityFrameInContainerSpace.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;accessibilityCustomRotors\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-16202.html#accessibilitycustomrotors-2419httpsdeveloperapplecomvideosplaywwdc2016202time1459"] = "[accessibilityCustomRotors (24:19)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1459)";
index.add({
    url: "dev-ios-wwdc-16202.html#accessibilitycustomrotors-2419httpsdeveloperapplecomvideosplaywwdc2016202time1459",
    title: "[accessibilityCustomRotors (24:19)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1459)",    
    body: "### [accessibilityCustomRotors (24:19)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1459) Customed elements can be added to a native `rotor` thanks to this **new iOS 10 feature**. &lt;/br&gt;&lt;img style=\&quot;max-width: 775px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc16-202-accessibilityCustomRotors.png\&quot; /&gt; &lt;/br&gt;The programming implementation of this feature is detailed in the [development part](./dev-ios.html#custom-rotor). &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;tvOS\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-16202.html#tvos-header-elements-3120httpsdeveloperapplecomvideosplaywwdc2016202time1880"] = "[tvOS header elements (31:20)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1880)";
index.add({
    url: "dev-ios-wwdc-16202.html#tvos-header-elements-3120httpsdeveloperapplecomvideosplaywwdc2016202time1880",
    title: "[tvOS header elements (31:20)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1880)",    
    body: "### [tvOS header elements (31:20)](https://developer.apple.com/videos/play/wwdc2016/202/?time=1880) This last section deals with reminders of header elements implementation and purpose inside a VoiceOVer navigation with tvOS. &lt;/br&gt;&lt;img style=\&quot;max-width: 500px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc16-202-tvOS_1.png\&quot; /&gt; &lt;/br&gt;&lt;img style=\&quot;max-width: 450px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc16-202-tvOS_2.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt; &lt;!--  This file is part of a11y-guidelines | Our vision of mobile &amp; web accessibility guidelines and best practices, with valid/invalid examples.  Copyright (C) 2016  Orange SA  See the Creative Commons Legal Code Attribution-ShareAlike 3.0 Unported License for more details (LICENSE file). --&gt;"
});
...
index.add({
    ...
    body: "# WWDC 2016 : Auditing Your Apps for Accessibility   &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;iOS\&quot;,\&quot;url\&quot;:\&quot;mobile-ios.html\&quot;},                    {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},                    {\&quot;label\&quot;:\&quot;2016 - Auditing Your Apps for Accessibility\&quot;}]);     addSubMenu([         {\&quot;label\&quot;:\&quot;Design criteria\&quot;,\&quot;url\&quot;:\&quot;criteria-ios.html\&quot;},          {\&quot;label\&quot;:\&quot;Developers guide\&quot;,\&quot;url\&quot;:\&quot;dev-ios.html\&quot;},         {\&quot;label\&quot;:\&quot;VoiceOver\&quot;,\&quot;url\&quot;:\&quot;voiceover.html\&quot;},         {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},         {\&quot;label\&quot;:\&quot;Tests\&quot;,\&quot;url\&quot;:\&quot;criteria-ios-test.html\&quot;}     ]);         });&lt;/script&gt;  &lt;span data-menuitem=\&quot;mobile-ios\&quot;&gt;&lt;/span&gt;  This video available on the **official Apple website** ([session 407](https://developer.apple.com/videos/play/wwdc2016/407/)) aims at defining and using the `Accessibility Inspector` tool of Xcode, based on good practice implementation. &lt;/br&gt;&lt;img style=\&quot;max-width: 200px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc16-logo.png\&quot; /&gt; &lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc16-407.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt;Various contents and their video timelapse are indicated hereunder : - [Accessibility Inspector](#AccessibilityInspector) (09:38) - [Audit](#Audit) (11:21) - [Inspection](#Inspection) (20:30) - [Settings](#Settings) (28:33)  Thereafter, the selection of a title will give rise to the video playback on the Apple website directly at the proper moment.  &lt;a name=\&quot;AccessibilityInspector\&quot;&gt;&lt;/a&gt; "
});
...
index.add({
    ...
    body: "# WWDC 2017 : Building Apps with Dynamic Type  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;iOS\&quot;,\&quot;url\&quot;:\&quot;mobile-ios.html\&quot;},                    {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},                    {\&quot;label\&quot;:\&quot;2017 - Building Apps with Dynamic Type\&quot;}]);     addSubMenu([         {\&quot;label\&quot;:\&quot;Design criteria\&quot;,\&quot;url\&quot;:\&quot;criteria-ios.html\&quot;},          {\&quot;label\&quot;:\&quot;Developers guide\&quot;,\&quot;url\&quot;:\&quot;dev-ios.html\&quot;},         {\&quot;label\&quot;:\&quot;VoiceOver\&quot;,\&quot;url\&quot;:\&quot;voiceover.html\&quot;},         {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},         {\&quot;label\&quot;:\&quot;Tests\&quot;,\&quot;url\&quot;:\&quot;criteria-ios-test.html\&quot;}     ]);         });&lt;/script&gt;  &lt;span data-menuitem=\&quot;mobile-ios\&quot;&gt;&lt;/span&gt;  This video available on the **official Apple website** ([session 245](https://developer.apple.com/videos/play/wwdc2017/245/)) aims at defining what `Dynamic Type` is, based on good practice implementation. &lt;/br&gt;&lt;img style=\&quot;max-width: 200px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc17-logo.png\&quot; /&gt; &lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc17-245.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt;Various contents and their video timelapse are indicated hereunder : - [Text styles](#TextStyles) (06:06) - [Custom fonts](#CustomFonts) (08:17) - [Web views](#WebViews) (09:25) - [Wrap to multiple lines](#WrapToMultipleLines) (10:14) - [Auto layout system spacing constraints](#AutoLayoutSystemSpacingConstraints) (11:31) - [Scaled values](#ScaledValue) (12:56) - [Side-by-side text](#SideBySideText) (13:36) - [PreferredContentSizeCategory](#PreferredContentSizeCategory) (15:23) - [Table view cells](#TableViewCells) (16:38) - [Images](#Images) (20:13) - [Example](#Demo) (24:32)  Thereafter, the selection of a title will give rise to the video playback on the Apple website directly at the proper moment.  &lt;a name=\&quot;TextStyles\&quot;&gt;&lt;/a&gt; "
});
...
index.add({
    ...
    body: "### [Wrap to multiple lines (10:14)](https://developer.apple.com/videos/play/wwdc2017/245/?time=614) When a `label` may be troncatured after adjustment, it's recommended to write `0` number of lines in the Attribute Inspector part of the Interface Builder that will be understood as no limit. &lt;/br&gt;&lt;img style=\&quot;max-width: 1000px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc17-245-WrapToMultipleLines.png\&quot; /&gt;  &lt;a name=\&quot;AutoLayoutSystemSpacingConstraints\&quot;&gt;&lt;/a&gt; "
});
...
index.add({
    ...
    body: "### [Images (20:13)](https://developer.apple.com/videos/play/wwdc2017/245/?time=1213) `Dynamic Type` allows image size adjustment for both views and tab bars as well. &lt;/br&gt;All the detailed explanations for this implementation can be found in the [development part](./dev-ios.html#graphical-elements-size).  &lt;a name=\&quot;Demo\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-17245.html#example-2432httpsdeveloperapplecomvideosplaywwdc2017245time1472"] = "[Example (24:32)](https://developer.apple.com/videos/play/wwdc2017/245/?time=1472)";
index.add({
    url: "dev-ios-wwdc-17245.html#example-2432httpsdeveloperapplecomvideosplaywwdc2017245time1472",
    title: "[Example (24:32)](https://developer.apple.com/videos/play/wwdc2017/245/?time=1472)",    
    body: "### [Example (24:32)](https://developer.apple.com/videos/play/wwdc2017/245/?time=1472) During this presentation, some solutions for `Dynamic Type` pitfalls are suggested thanks to a simple application ([take a look at it](https://developer.apple.com/videos/play/wwdc2017/245/?time=1506) before reading what's next) : - **Why doesn't my implemented `Dynamic Type` work** ? [(26:19)](https://developer.apple.com/videos/play/wwdc2017/245/?time=1579) (hint = `adjustsFontForContentSizeCategory` (code) or `Automatically Adjusts Font` (Attribute Inspector) + `scaledFont` if custom font is used) - **How can I change items position to adapt text enlargement** ? [(28:01)](https://developer.apple.com/videos/play/wwdc2017/245/?time=1681) (hint = set up constraints for a vertical alignment + define these new constraints activation thanks to `preferredContentSizeCategory` + `traitCollectionDidChange` to be notified of a text size changing) - **How to make my table view cells size to fit content** ? [(31:03)](https://developer.apple.com/videos/play/wwdc2017/245/?time=1863) (hint = `UITableViewAutomaticDimension` + `estimatedRowHeight`) - **Why is there unscaled image size with the text enlargement** ? [(32:11)](https://developer.apple.com/videos/play/wwdc2017/245/?time=1931) (hint = `adjustsImageSizeForAccessibilityContentSizeCategory`) - **Why have I unsmooth images when enlargement is set up** ? [(33:07)](https://developer.apple.com/videos/play/wwdc2017/245/?time=1987) (hint = `Preserve Vector Data` in the Attribute Inspector of the .xcassets) - **How can I check enlargement with accessibility inspector** ? [(34:56)](https://developer.apple.com/videos/play/wwdc2017/245/?time=2096)  &lt;!--  This file is part of a11y-guidelines | Our vision of mobile &amp; web accessibility guidelines and best practices, with valid/invalid examples.  Copyright (C) 2016  Orange SA  See the Creative Commons Legal Code Attribution-ShareAlike 3.0 Unported License for more details (LICENSE file). --&gt;"
});



documentTitles["dev-ios-wwdc-18230.html#wwdc-2018-deliver-an-exceptional-accessibility-experience"] = "WWDC 2018 : Deliver an exceptional accessibility experience";
index.add({
    url: "dev-ios-wwdc-18230.html#wwdc-2018-deliver-an-exceptional-accessibility-experience",
    title: "WWDC 2018 : Deliver an exceptional accessibility experience",    
    body: "# WWDC 2018 : Deliver an exceptional accessibility experience  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;iOS\&quot;,\&quot;url\&quot;:\&quot;mobile-ios.html\&quot;},                    {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},                    {\&quot;label\&quot;:\&quot;2018 - Deliver an exceptional accessibility experience\&quot;}]);     addSubMenu([         {\&quot;label\&quot;:\&quot;Design criteria\&quot;,\&quot;url\&quot;:\&quot;criteria-ios.html\&quot;},          {\&quot;label\&quot;:\&quot;Developers guide\&quot;,\&quot;url\&quot;:\&quot;dev-ios.html\&quot;},         {\&quot;label\&quot;:\&quot;VoiceOver\&quot;,\&quot;url\&quot;:\&quot;voiceover.html\&quot;},         {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},         {\&quot;label\&quot;:\&quot;Tests\&quot;,\&quot;url\&quot;:\&quot;criteria-ios-test.html\&quot;}     ]);         });&lt;/script&gt;  &lt;span data-menuitem=\&quot;mobile-ios\&quot;&gt;&lt;/span&gt;  This video available on the **official Apple website** ([session 230](https://developer.apple.com/videos/play/wwdc2018/230/)) aims at highlighting the essential elements that will provide an optimal user experience for visual impaired people. &lt;/br&gt;&lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt;Various contents and their video timelapse are indicated hereunder :  - [Transparency and blurring](#TransparencyAndBlurring) (03:07) - [Contrast](#Contrast) (04:38) - [Sizing](#Sizing) (07:04) - [Motion](#Motion) (08:48) - [UIAccessibilityElement](#UIAccessibilityElement) (21:03) - [Adjustable values](#AdjustableValues) (21:44) - [Custom actions](#CustomActions) (23:49) - [Accessibility modal view](#accessibilityViewIsModal) (25:02) - [Notifications](#Notifications) (25:13) - [Demo](#Demo)     - [How to render a carousel perfectly VoiceOver understandable ?](#DemoSetCarousel) (25:53)     - [How to synchronize the selected carousel element with the displayed data ?](#DemoUpdateData) (30:53)     - [How to gather actions with an elements regroupment ?](#DemoCustomActions) (33:05)     - [How to avoid selections behind a 'Modal View' ?](#DemoModalView) (34:32)     - [Final rendering with an optimized VoiceOver implementation.](#DemoExceptionalVoiceOverExperience) (35:38)  The latest content points out an amazing application for :  - The developers interested in finding out detailed explanations about many VoiceOver implementations. - Those who are willing to figure out how a mobile application should interact with VoiceOver to obtain an optimal user experience (see '[Final rendering with an optimized VoiceOver implementation](#DemoExceptionalVoiceOverExperience)').  Thereafter, the selection of a title will give rise to the video playback on the Apple website directly at the proper moment. &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;TransparencyAndBlurring\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#transparency-and-blurring-0307httpsdeveloperapplecomvideosplaywwdc2018230time187"] = "[Transparency and blurring (03:07)](https://developer.apple.com/videos/play/wwdc2018/230/?time=187)";
index.add({
    url: "dev-ios-wwdc-18230.html#transparency-and-blurring-0307httpsdeveloperapplecomvideosplaywwdc2018230time187",
    title: "[Transparency and blurring (03:07)](https://developer.apple.com/videos/play/wwdc2018/230/?time=187)",    
    body: "### [Transparency and blurring (03:07)](https://developer.apple.com/videos/play/wwdc2018/230/?time=187) Since iOS 8, classes such as `UIBlurEffect` and `UIVisualEffectView` perfectly handle the blurring effect of an image. &lt;/br&gt;However, this could give rise to sighting difficulties for some people having visual impairments. &lt;/br&gt;In this case, there's a possibility for the user to drastically weaken these effects by activating the appropriate [accessibility option](./criteria-ios.html#accessibility-options) in his settings. &lt;/br&gt;&lt;img style=\&quot;max-width: 950px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-TransparencyAndBlurring_1.png\&quot; /&gt; &lt;/br&gt;The result is a darker background that may become completely uniform under certain circumstances. &lt;/br&gt;&lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-TransparencyAndBlurring_2.png\&quot; /&gt; &lt;/br&gt;The `isReduceTransparencyEnabled` property value is available in the programing language as well. &lt;/br&gt;&lt;img style=\&quot;max-width: 650px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-TransparencyAndBlurring_3.png\&quot; /&gt;  &lt;a name=\&quot;Contrast\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#contrast-0438httpsdeveloperapplecomvideosplaywwdc2018230time278"] = "[Contrast (04:38)](https://developer.apple.com/videos/play/wwdc2018/230/?time=278)";
index.add({
    url: "dev-ios-wwdc-18230.html#contrast-0438httpsdeveloperapplecomvideosplaywwdc2018230time278",
    title: "[Contrast (04:38)](https://developer.apple.com/videos/play/wwdc2018/230/?time=278)",    
    body: "### [Contrast (04:38)](https://developer.apple.com/videos/play/wwdc2018/230/?time=278) The contrast between the foreground and the background colors is very important and depends a lot on the font type properties that are detailed in the [iOS guide section](./criteria-ios.html#colours) of this site. &lt;/br&gt;To improve the reading experience, it's natively possible to increase the colors contrast by activating the appropriate [accessibility option](./criteria-ios.html#accessibility-options) in the settings. &lt;/br&gt;&lt;img style=\&quot;max-width: 600px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-Contrast_1.png\&quot; /&gt; &lt;/br&gt;The `isDarkerSystemColorsEnabled` property enables the developed application to be informed of its value. &lt;/br&gt;&lt;img style=\&quot;max-width: 650px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-Contrast_2.png\&quot; /&gt;  &lt;a name=\&quot;Sizing\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#sizing-0704httpsdeveloperapplecomvideosplaywwdc2018230time424"] = "[Sizing (07:04)](https://developer.apple.com/videos/play/wwdc2018/230/?time=424)";
index.add({
    url: "dev-ios-wwdc-18230.html#sizing-0704httpsdeveloperapplecomvideosplaywwdc2018230time424",
    title: "[Sizing (07:04)](https://developer.apple.com/videos/play/wwdc2018/230/?time=424)",    
    body: "### [Sizing (07:04)](https://developer.apple.com/videos/play/wwdc2018/230/?time=424) The individual presented elements about the `Dynamic Type` are widely explained in the [iOS developement section](./dev-ios.html#text-size) and refer to [another presentation](./dev-ios-wwdc-17245.html) detailed in the WWDC part of this site. &lt;/br&gt;Display a bold font type may improve the visual rendering enough without disproportionately increase the font size. &lt;/br&gt;Once more, this [accessibility option](./criteria-ios.html#accessibility-options) can be activated in the mobile settings. &lt;/br&gt;&lt;img style=\&quot;max-width: 600px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-Sizing_1.png\&quot; /&gt; &lt;/br&gt;The `isBoldTextEnabled` property enables the developed application to be informed of its value. &lt;/br&gt;&lt;img style=\&quot;max-width: 600px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-Sizing_2.png\&quot; /&gt;  &lt;a name=\&quot;Motion\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#motion-0848httpsdeveloperapplecomvideosplaywwdc2018230time528"] = "[Motion (08:48)](https://developer.apple.com/videos/play/wwdc2018/230/?time=528)";
index.add({
    url: "dev-ios-wwdc-18230.html#motion-0848httpsdeveloperapplecomvideosplaywwdc2018230time528",
    title: "[Motion (08:48)](https://developer.apple.com/videos/play/wwdc2018/230/?time=528)",    
    body: "### [Motion (08:48)](https://developer.apple.com/videos/play/wwdc2018/230/?time=528) Any animations may give rise to problems of balance even of nausea to certain people. &lt;/br&gt;The user settings allow to strongly decrease the effects of all kind of native animations by activating the appropriate [accessibility option](./criteria-ios.html#accessibility-options). &lt;/br&gt;&lt;img style=\&quot;max-width: 950px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-Motion_1.png\&quot; /&gt; &lt;/br&gt;The `isReduceMotionEnabled` property enables the developed application to be adapted to the user preference. &lt;/br&gt;&lt;img style=\&quot;max-width: 600px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-Motion_2.png\&quot; /&gt;  &lt;a name=\&quot;UIAccessibilityElement\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#uiaccessibilityelement-2103httpsdeveloperapplecomvideosplaywwdc2018230time1263"] = "[UIAccessibilityElement (21:03)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1263)";
index.add({
    url: "dev-ios-wwdc-18230.html#uiaccessibilityelement-2103httpsdeveloperapplecomvideosplaywwdc2018230time1263",
    title: "[UIAccessibilityElement (21:03)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1263)",    
    body: "### [UIAccessibilityElement (21:03)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1263) The implementation and the purpose of this element are explained and introduced inside the demo application. &lt;/br&gt;&lt;img style=\&quot;max-width: 550px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-UIAccessibilityElement.png\&quot; /&gt;  &lt;a name=\&quot;AdjustableValues\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#adjustable-values-2144httpsdeveloperapplecomvideosplaywwdc2018230time1304"] = "[Adjustable values (21:44)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1304)";
index.add({
    url: "dev-ios-wwdc-18230.html#adjustable-values-2144httpsdeveloperapplecomvideosplaywwdc2018230time1304",
    title: "[Adjustable values (21:44)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1304)",    
    body: "### [Adjustable values (21:44)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1304) This functionality that is implemented thanks to a specific trait is specifically introduced in this presentation so as to **ease the element selection** inside a `CollectionView`. &lt;/br&gt;&lt;img style=\&quot;max-width: 550px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-AdjustableValues.png\&quot; /&gt; &lt;/br&gt;A different outline of this functionality is developed in [another presentation](./dev-ios-wwdc-17215.html#AdjustableValues) detailed in the WWDC part of this site. &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;CustomActions\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#custom-actions-2349httpsdeveloperapplecomvideosplaywwdc2018230time1429"] = "[Custom actions (23:49)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1429)";
index.add({
    url: "dev-ios-wwdc-18230.html#custom-actions-2349httpsdeveloperapplecomvideosplaywwdc2018230time1429",
    title: "[Custom actions (23:49)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1429)",    
    body: "### [Custom actions (23:49)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1429) On a single selection, it's possible to **gather many actions** that are initially trigerred by distinct graphic elements. &lt;/br&gt;&lt;img style=\&quot;max-width: 700px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-CustomActions.png\&quot; /&gt; &lt;/br&gt;All the explanations are also exposed in [another presentation](./dev-ios-wwdc-17215.html#CustomActions) detailed in the WWDC part of this site. &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;accessibilityViewIsModal\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#accessibility-modal-view-2502httpsdeveloperapplecomvideosplaywwdc2018230time1502"] = "[Accessibility modal view (25:02)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1502)";
index.add({
    url: "dev-ios-wwdc-18230.html#accessibility-modal-view-2502httpsdeveloperapplecomvideosplaywwdc2018230time1502",
    title: "[Accessibility modal view (25:02)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1502)",    
    body: "### [Accessibility modal view (25:02)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1502) When a view is only presented as being at the top of the view hierarchy, VoiceOver doesn't know natively that the **background elements mustn't be analyzed**. &lt;/br&gt;The solution deals with the `accessibilityViewIsModal` value so as to avoid VoiceOVer to check other elements than those in the foreground. &lt;/br&gt;&lt;img style=\&quot;max-width: 450px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-ModalView.png\&quot; /&gt;  &lt;a name=\&quot;Notifications\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#notifications-2513httpsdeveloperapplecomvideosplaywwdc2018230time1513"] = "[Notifications (25:13)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1513)";
index.add({
    url: "dev-ios-wwdc-18230.html#notifications-2513httpsdeveloperapplecomvideosplaywwdc2018230time1513",
    title: "[Notifications (25:13)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1513)",    
    body: "### [Notifications (25:13)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1513) Reminder to **notify the users about modifications** on the screen. &lt;/br&gt;&lt;img style=\&quot;max-width: 800px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-230-Notifications.png\&quot; /&gt; &lt;/br&gt;More detailed explanations are available in the [developer part](./dev-ios.html#notify-a-content-change) of this site. &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;Demo\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#demo"] = "Demo";
index.add({
    url: "dev-ios-wwdc-18230.html#demo",
    title: "Demo",    
    body: "### Demo During this presentation, some solutions for VoiceOver implementation pitfalls are suggested thanks to a simple application. &lt;/br&gt;First of all, the [application introduction](https://developer.apple.com/videos/play/wwdc2018/230/?time=938) and the [non optimized VoiceOver rendering](https://developer.apple.com/videos/play/wwdc2018/230/?time=1022) must be watched in order to understand the rationale behind the proposed solutions. &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;DemoSetCarousel\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#how-to-render-a-carousel-perfectly-voiceover-understandable-2553httpsdeveloperapplecomvideosplaywwdc2018230time1553"] = "[How to render a carousel perfectly VoiceOver understandable ? (25:53)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1553)";
index.add({
    url: "dev-ios-wwdc-18230.html#how-to-render-a-carousel-perfectly-voiceover-understandable-2553httpsdeveloperapplecomvideosplaywwdc2018230time1553",
    title: "[How to render a carousel perfectly VoiceOver understandable ? (25:53)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1553)",    
    body: "##### [How to render a carousel perfectly VoiceOver understandable ? (25:53)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1553) - Create an accessible element to define the carousel. [(26:11)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1571) - Implementations of the `label` and `value` properties. [(26:43)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1603) - Definition of `adjustableTrait` with its `increment` and `decrement` methods. [(26:58)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1618) - Creation of a scrolling function. [(27:14)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1634) - Add the carousel element as an accessible element. [(28:38)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1718) - Updating of the displayed data in conjunction with the user selection. [(29:51)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1791) - Screen updating notification when a carousel element selection occurs. [(30:14)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1814) &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;DemoUpdateData\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#how-to-synchronize-the-selected-carousel-element-with-the-displayed-data-3053httpsdeveloperapplecomvideosplaywwdc2018230time1853"] = "[How to synchronize the selected carousel element with the displayed data ? (30:53)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1853)";
index.add({
    url: "dev-ios-wwdc-18230.html#how-to-synchronize-the-selected-carousel-element-with-the-displayed-data-3053httpsdeveloperapplecomvideosplaywwdc2018230time1853",
    title: "[How to synchronize the selected carousel element with the displayed data ? (30:53)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1853)",    
    body: "##### [How to synchronize the selected carousel element with the displayed data ? (30:53)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1853) - Gather elements to significatively improve the selection. [(31:14)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1874) - Synchronization of the regrouped elements with the selected carousel element. [(32:46)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1966) &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;DemoCustomActions\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#how-to-gather-actions-with-an-elements-regroupment-3305httpsdeveloperapplecomvideosplaywwdc2018230time1985"] = "[How to gather actions with an elements regroupment ? (33:05)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1985)";
index.add({
    url: "dev-ios-wwdc-18230.html#how-to-gather-actions-with-an-elements-regroupment-3305httpsdeveloperapplecomvideosplaywwdc2018230time1985",
    title: "[How to gather actions with an elements regroupment ? (33:05)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1985)",    
    body: "##### [How to gather actions with an elements regroupment ? (33:05)](https://developer.apple.com/videos/play/wwdc2018/230/?time=1985) &lt;/br&gt; &lt;a name=\&quot;DemoModalView\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#how-to-avoid-selections-behind-a-modal-view"] = "How to avoid selections behind a 'Modal View' ?";
index.add({
    url: "dev-ios-wwdc-18230.html#how-to-avoid-selections-behind-a-modal-view",
    title: "How to avoid selections behind a 'Modal View' ?",    
    body: "##### How to avoid selections behind a 'Modal View' ? - Override `accessibilityViewIsModal`. [(34:33)](https://developer.apple.com/videos/play/wwdc2018/230/?time=2073) - Notify the user of a new presented screen. [(35:00)](https://developer.apple.com/videos/play/wwdc2018/230/?time=2100) &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;DemoExceptionalVoiceOverExperience\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18230.html#final-rendering-with-an-optimized-voiceover-implementation-3538httpsdeveloperapplecomvideosplaywwdc2018230time2138"] = "[Final rendering with an optimized VoiceOver implementation. (35:38)](https://developer.apple.com/videos/play/wwdc2018/230/?time=2138)";
index.add({
    url: "dev-ios-wwdc-18230.html#final-rendering-with-an-optimized-voiceover-implementation-3538httpsdeveloperapplecomvideosplaywwdc2018230time2138",
    title: "[Final rendering with an optimized VoiceOver implementation. (35:38)](https://developer.apple.com/videos/play/wwdc2018/230/?time=2138)",    
    body: "##### [Final rendering with an optimized VoiceOver implementation. (35:38)](https://developer.apple.com/videos/play/wwdc2018/230/?time=2138)  &lt;/br&gt; The presented code of this video and many explanations of its implementation are available on the [Apple developer site](https://developer.apple.com/documentation/uikit/accessibility/delivering_an_exceptional_accessibility_experience).  &lt;!--  This file is part of a11y-guidelines | Our vision of mobile &amp; web accessibility guidelines and best practices, with valid/invalid examples.  Copyright (C) 2016  Orange SA  See the Creative Commons Legal Code Attribution-ShareAlike 3.0 Unported License for more details (LICENSE file). --&gt;"
});



documentTitles["dev-ios-wwdc-18236.html#wwdc-2018-making-ios-talk-with-avspeechsynthesizer"] = "WWDC 2018 : Making iOS talk with AVSpeechSynthesizer";
index.add({
    url: "dev-ios-wwdc-18236.html#wwdc-2018-making-ios-talk-with-avspeechsynthesizer",
    title: "WWDC 2018 : Making iOS talk with AVSpeechSynthesizer",    
    body: "# WWDC 2018 : Making iOS talk with AVSpeechSynthesizer  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;iOS\&quot;,\&quot;url\&quot;:\&quot;mobile-ios.html\&quot;},                    {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},                    {\&quot;label\&quot;:\&quot;2018 - AVSpeechSynthesizer\&quot;} 	]);     addSubMenu([         {\&quot;label\&quot;:\&quot;Design criteria\&quot;,\&quot;url\&quot;:\&quot;criteria-ios.html\&quot;},          {\&quot;label\&quot;:\&quot;Developers guide\&quot;,\&quot;url\&quot;:\&quot;dev-ios.html\&quot;},         {\&quot;label\&quot;:\&quot;VoiceOver\&quot;,\&quot;url\&quot;:\&quot;voiceover.html\&quot;},         {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},         {\&quot;label\&quot;:\&quot;Tests\&quot;,\&quot;url\&quot;:\&quot;criteria-ios-test.html\&quot;}     ]); });&lt;/script&gt;  &lt;span data-menuitem=\&quot;mobile-ios\&quot;&gt;&lt;/span&gt;  This video available on the **official Apple website** ([session 236](https://developer.apple.com/videos/play/wwdc2018/236/)) aims at highlighting the essential elements to be implemented in order to **use a synthesized speech thanks to AVSpeechSynthesizer**. &lt;/br&gt;&lt;img style=\&quot;max-width: 466px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-236.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt;Various contents and their video timelapse are indicated hereunder :  - [Uses](#Uses) (00:48) - [Basics](#Basics) (02:03) - [AVSpeechSynthesizerDelegate](#AVSpeechSynthesizerDelegate) (03:20) - [Demo](#Demo) (04:11) - [Choosing the right voice](#TheRightVoice) (04:31) - [Speech rate](#SpeechRate) (05:32) - [Pitch and volume](#PitchAndVolume) (06:15) - [Phonetics](#IPA) (06:54)  Thereafter, the selection of a title will give rise to the video playback on the Apple website directly at the proper moment. &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;Uses\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18236.html#uses-0048httpsdeveloperapplecomvideosplaywwdc2018236time48"] = "[Uses (00:48)](https://developer.apple.com/videos/play/wwdc2018/236/?time=48)";
index.add({
    url: "dev-ios-wwdc-18236.html#uses-0048httpsdeveloperapplecomvideosplaywwdc2018236time48",
    title: "[Uses (00:48)](https://developer.apple.com/videos/play/wwdc2018/236/?time=48)",    
    body: "### [Uses (00:48)](https://developer.apple.com/videos/play/wwdc2018/236/?time=48) The wide range of possible use cases offered by this ** iOS 12 new feature** are introduced in this section. &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;Basics\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18236.html#basics-0203httpsdeveloperapplecomvideosplaywwdc2018236time123"] = "[Basics (02:03)](https://developer.apple.com/videos/play/wwdc2018/236/?time=123)";
index.add({
    url: "dev-ios-wwdc-18236.html#basics-0203httpsdeveloperapplecomvideosplaywwdc2018236time123",
    title: "[Basics (02:03)](https://developer.apple.com/videos/play/wwdc2018/236/?time=123)",    
    body: "### [Basics (02:03)](https://developer.apple.com/videos/play/wwdc2018/236/?time=123) Using a synthesized speech first implies a **`AVSpeechSynthesizer` instance creation** that must be retained until the speech is done. &lt;/br&gt;&lt;img style=\&quot;max-width: 400px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-236-Basics_1.png\&quot; /&gt; &lt;/br&gt;Then **create an utterance** that must be provided to the previous instance. &lt;/br&gt;&lt;img style=\&quot;max-width: 500px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-236-Basics_2.png\&quot; /&gt; &lt;/br&gt;In this case, an audio session is automatically activated and may be used together with the speech synthesis. &lt;/br&gt;&lt;img style=\&quot;max-width: 850px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-236-Basics_3.png\&quot; /&gt; &lt;/br&gt;This session must be explicitly deactivated after speech is done. &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;AVSpeechSynthesizerDelegate\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18236.html#avspeechsynthesizerdelegate-0320httpsdeveloperapplecomvideosplaywwdc2018236time200"] = "[AVSpeechSynthesizerDelegate (03:20)](https://developer.apple.com/videos/play/wwdc2018/236/?time=200)";
index.add({
    url: "dev-ios-wwdc-18236.html#avspeechsynthesizerdelegate-0320httpsdeveloperapplecomvideosplaywwdc2018236time200",
    title: "[AVSpeechSynthesizerDelegate (03:20)](https://developer.apple.com/videos/play/wwdc2018/236/?time=200)",    
    body: "### [AVSpeechSynthesizerDelegate (03:20)](https://developer.apple.com/videos/play/wwdc2018/236/?time=200) This protocol encompasses many **optional methods that handle speech synthesis events** :  - Pauses and resumes. - Starts and ends of the `AVSpeechUtterance ` instances. - Spoken character range. &lt;/br&gt;&lt;img style=\&quot;max-width: 900px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-236-AVSpeechSynthesizerDelegate.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;Demo\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18236.html#demo-0411httpsdeveloperapplecomvideosplaywwdc2018236time251"] = "[Demo (04:11)](https://developer.apple.com/videos/play/wwdc2018/236/?time=251)";
index.add({
    url: "dev-ios-wwdc-18236.html#demo-0411httpsdeveloperapplecomvideosplaywwdc2018236time251",
    title: "[Demo (04:11)](https://developer.apple.com/videos/play/wwdc2018/236/?time=251)",    
    body: "### [Demo (04:11)](https://developer.apple.com/videos/play/wwdc2018/236/?time=251) Simple example of a speech synthesis highlighted thanks to the `AVSpeechSynthesizerDelegate` protocol methods. &lt;/br&gt;&lt;img style=\&quot;max-width: 230px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-236-Demo.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;TheRightVoice\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18236.html#choosing-the-right-voice-0431httpsdeveloperapplecomvideosplaywwdc2018236time271"] = "[Choosing the right voice (04:31)](https://developer.apple.com/videos/play/wwdc2018/236/?time=271)";
index.add({
    url: "dev-ios-wwdc-18236.html#choosing-the-right-voice-0431httpsdeveloperapplecomvideosplaywwdc2018236time271",
    title: "[Choosing the right voice (04:31)](https://developer.apple.com/videos/play/wwdc2018/236/?time=271)",    
    body: "### [Choosing the right voice (04:31)](https://developer.apple.com/videos/play/wwdc2018/236/?time=271) The default voice is the built-in voice of the device supported language. &lt;/br&gt;&lt;img style=\&quot;max-width: 1000px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-236-TheRightVoice_1.png\&quot; /&gt; &lt;/br&gt;However, it's still possible to select another voice specifying the desired language or using an identifier inside an array of speech voices that have been downloaded. &lt;/br&gt;&lt;img style=\&quot;max-width: 800px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-236-TheRightVoice_2.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;SpeechRate\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18236.html#speech-rate-0532httpsdeveloperapplecomvideosplaywwdc2018236time332"] = "[Speech rate (05:32)](https://developer.apple.com/videos/play/wwdc2018/236/?time=332)";
index.add({
    url: "dev-ios-wwdc-18236.html#speech-rate-0532httpsdeveloperapplecomvideosplaywwdc2018236time332",
    title: "[Speech rate (05:32)](https://developer.apple.com/videos/play/wwdc2018/236/?time=332)",    
    body: "### [Speech rate (05:32)](https://developer.apple.com/videos/play/wwdc2018/236/?time=332) The speech rate can be changed thanks to the rate property going from 0 to 1. &lt;/br&gt;&lt;img style=\&quot;max-width: 530px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-236-SpeechRate.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;PitchAndVolume\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18236.html#pitch-and-volume-0615httpsdeveloperapplecomvideosplaywwdc2018236time375"] = "[Pitch and volume (06:15)](https://developer.apple.com/videos/play/wwdc2018/236/?time=375)";
index.add({
    url: "dev-ios-wwdc-18236.html#pitch-and-volume-0615httpsdeveloperapplecomvideosplaywwdc2018236time375",
    title: "[Pitch and volume (06:15)](https://developer.apple.com/videos/play/wwdc2018/236/?time=375)",    
    body: "### [Pitch and volume (06:15)](https://developer.apple.com/videos/play/wwdc2018/236/?time=375) The pitch tone and the speech volume can be easily modified without affecting the system volume. &lt;/br&gt;&lt;img style=\&quot;max-width: 720px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-236-PitchAndVolume.png\&quot; /&gt; &lt;/br&gt;&lt;/br&gt; &lt;a name=\&quot;IPA\&quot;&gt;&lt;/a&gt; "
});

documentTitles["dev-ios-wwdc-18236.html#phonetics-0654httpsdeveloperapplecomvideosplaywwdc2018236time414"] = "[Phonetics (06:54)](https://developer.apple.com/videos/play/wwdc2018/236/?time=414)";
index.add({
    url: "dev-ios-wwdc-18236.html#phonetics-0654httpsdeveloperapplecomvideosplaywwdc2018236time414",
    title: "[Phonetics (06:54)](https://developer.apple.com/videos/play/wwdc2018/236/?time=414)",    
    body: "### [Phonetics (06:54)](https://developer.apple.com/videos/play/wwdc2018/236/?time=414) The &lt;abbr&gt;IPA&lt;/abbr&gt; can be used with **Attributed Strings** in order to customize how specialized names, words or sentences are pronounced. &lt;/br&gt;&lt;img style=\&quot;max-width: 800px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iOSdev/wwdc18-236-IPA.png\&quot; /&gt; &lt;/br&gt;Attributed strings may also be used to specify a different language for a part of a sentence for instance. &lt;/br&gt;&lt;/br&gt;   &lt;!--  This file is part of a11y-guidelines | Our vision of mobile &amp; web accessibility guidelines and best practices, with valid/invalid examples.  Copyright (C) 2016  Orange SA  See the Creative Commons Legal Code Attribution-ShareAlike 3.0 Unported License for more details (LICENSE file). --&gt;"
});
...
index.add({
    ...
    body: "## Mobile accessibility definition ** It is an application usable by everyone **  - People with no disabilities. - Elderly people. - People with disabilities *(temporary or permanent)*.  ** and in all situations **  - With any kind of material: mobile browser, Android, iOS, tablet. - In an unfavourable environment: poor luminosity, touchpad while moving,... - With specific software that compensate the handicap.  "
});
...
index.add({
    ...
    title: "3. VoiceOver",    
    body: "#### 3. VoiceOver Guide to using the native screen reader. &lt;/br&gt;Details all the necessary gestures for a VoiceOver complete mastery. &lt;/br&gt;&lt;/br&gt; "
});
...
index.add({
    ...
    title: "4. WWDC",    
    body: "#### 4. WWDC Contains many detailed `World Wide Developers Conference` videos that represent a significant milestone to mobile accessibility. &lt;/br&gt;&lt;/br&gt; "
});
...
index.add({
    ...
    title: "5. Tests",    
    body: "#### 5. Tests Includes tests to be done so as to be sure that the iOS recommendations are taken into account before the prod launching. &lt;/br&gt;&lt;/br&gt; "
});
...
index.add({
    url: "index.html#mdan",
    title: "mDAN",    
    body: "### mDAN mDAN application overview, the digital accessibility demonstrator for mobile. &lt;/br&gt;&lt;/br&gt; "
});
...
documentTitles["mobile-android.html#android-accessibility"] = "Android accessibility";
index.add({
    url: "mobile-android.html#android-accessibility",
    title: "Android accessibility",    
    body: "# Android accessibility  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;Android\&quot;}]);     addSubMenu([         {\&quot;label\&quot;:\&quot;Design criteria\&quot;,\&quot;url\&quot;:\&quot;criteria-android.html\&quot;},          {\&quot;label\&quot;:\&quot;Developers guide\&quot;,\&quot;url\&quot;:\&quot;dev-android.html\&quot;},         {\&quot;label\&quot;:\&quot;TalkBack\&quot;,\&quot;url\&quot;:\&quot;talkback.html\&quot;}     ]);         });&lt;/script&gt;  &lt;span data-menuitem=\&quot;mobile-android\&quot;&gt;&lt;/span&gt;  ... to be completed.         &lt;!--  This file is part of a11y-guidelines | Our vision of mobile &amp; web accessibility guidelines and best practices, with valid/invalid examples.  Copyright (C) 2016  Orange SA  See the Creative Commons Legal Code Attribution-ShareAlike 3.0 Unported License for more details (LICENSE file). --&gt;"
});



documentTitles["mobile-ios.html#ios-accessibility"] = "iOS accessibility";
index.add({
    url: "mobile-ios.html#ios-accessibility",
    title: "iOS accessibility",    
    body: "# iOS accessibility  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;iOS\&quot;}]);     addSubMenu([         {\&quot;label\&quot;:\&quot;Design criteria\&quot;,\&quot;url\&quot;:\&quot;criteria-ios.html\&quot;},          {\&quot;label\&quot;:\&quot;Developers guide\&quot;,\&quot;url\&quot;:\&quot;dev-ios.html\&quot;},         {\&quot;label\&quot;:\&quot;VoiceOver\&quot;,\&quot;url\&quot;:\&quot;voiceover.html\&quot;},         {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},         {\&quot;label\&quot;:\&quot;Tests\&quot;,\&quot;url\&quot;:\&quot;criteria-ios-test.html\&quot;}     ]);         });&lt;/script&gt;  &lt;span data-menuitem=\&quot;mobile-ios\&quot;&gt;&lt;/span&gt; Many accessibility concepts must be perfectly understood in order to bring the best user experience. &lt;/br&gt;All these basic and advanced notions are illustrated and explained within the following sections : &lt;/br&gt;&lt;/br&gt; "
});

documentTitles["mobile-ios.html#design-criteriacriteria-ioshtml"] = "[Design criteria](./criteria-ios.html)";
index.add({
    url: "mobile-ios.html#design-criteriacriteria-ioshtml",
    title: "[Design criteria](./criteria-ios.html)",    
    body: "## [Design criteria](./criteria-ios.html) This section introduces the different accessibility criteria for getting an accessible iOS application. &lt;/br&gt;&lt;/br&gt; "
});

documentTitles["mobile-ios.html#developers-guidedev-ioshtml"] = "[Developers guide](./dev-ios.html)";
index.add({
    url: "mobile-ios.html#developers-guidedev-ioshtml",
    title: "[Developers guide](./dev-ios.html)",    
    body: "## [Developers guide](./dev-ios.html) This guide aims at helping the iOS developers to understand and implement the functionalities that enable a perfect accessibility through their apps thanks to illustrations and code snippets. &lt;/br&gt;&lt;/br&gt; "
});

documentTitles["mobile-ios.html#voiceovervoiceoverhtml"] = "[VoiceOver](./voiceover.html)";
index.add({
    url: "mobile-ios.html#voiceovervoiceoverhtml",
    title: "[VoiceOver](./voiceover.html)",    
    body: "## [VoiceOver](./voiceover.html) The best way to provide a good VoiceOver user experience is to get a perfect mastery of this screen reader gestures. These gestures are all illustrated and well explained in this section. &lt;/br&gt;&lt;/br&gt; "
});

documentTitles["mobile-ios.html#wwdcdev-ios-wwdchtml"] = "[WWDC](./dev-ios-wwdc.html)";
index.add({
    url: "mobile-ios.html#wwdcdev-ios-wwdchtml",
    title: "[WWDC](./dev-ios-wwdc.html)",    
    body: "## [WWDC](./dev-ios-wwdc.html) This section gathers presentations at the `World Wide Developers Conference` dealing with accessibility. Each one of them is detailed with time references to their different contents. &lt;/br&gt;&lt;/br&gt; "
});

documentTitles["mobile-ios.html#testscriteria-ios-testhtml"] = "[Tests](./criteria-ios-test.html)";
index.add({
    url: "mobile-ios.html#testscriteria-ios-testhtml",
    title: "[Tests](./criteria-ios-test.html)",    
    body: "## [Tests](./criteria-ios-test.html) This part contains testings that follow the iOS recommendations.  &lt;!--  This file is part of a11y-guidelines | Our vision of mobile &amp; web accessibility guidelines and best practices, with valid/invalid examples.  Copyright (C) 2016  Orange SA  See the Creative Commons Legal Code Attribution-ShareAlike 3.0 Unported License for more details (LICENSE file). --&gt;"
});
...
index.add({
    ...
    body: "# VoiceOver user guide  &lt;script&gt;$(document).ready(function () {     setBreadcrumb([{\&quot;label\&quot;:\&quot;iOS\&quot;,\&quot;url\&quot;:\&quot;mobile-ios.html\&quot;},                    {\&quot;label\&quot;:\&quot;VoiceOver\&quot;}]);     addSubMenu([         {\&quot;label\&quot;:\&quot;Design criteria\&quot;,\&quot;url\&quot;:\&quot;criteria-ios.html\&quot;},          {\&quot;label\&quot;:\&quot;Developers guide\&quot;,\&quot;url\&quot;:\&quot;dev-ios.html\&quot;},         {\&quot;label\&quot;:\&quot;VoiceOver\&quot;,\&quot;url\&quot;:\&quot;voiceover.html\&quot;, \&quot;expanded\&quot;: true},         {\&quot;label\&quot;:\&quot;WWDC\&quot;,\&quot;url\&quot;:\&quot;dev-ios-wwdc.html\&quot;},         {\&quot;label\&quot;:\&quot;Tests\&quot;,\&quot;url\&quot;:\&quot;criteria-ios-test.html\&quot;}     ]);         });&lt;/script&gt;  &lt;span data-menuitem=\&quot;mobile-ios\&quot;&gt;&lt;/span&gt;  VoiceOver is a built-in screen reader that reads aloud the items that appear on the device screen. &lt;/br&gt;It vocalizes all visible elements in the page specially for blind or impaired, dyslexic or illiterate users.  VoiceOver can be switched on thanks to the `Settings` - `General` - `Accessibility` - `VoiceOver` device menu. &lt;/br&gt;&lt;img style=\&quot;max-width: 1100px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iphonex_voiceOverActivation.png\&quot; /&gt; When VoiceOver is on, the standard gestures behave differently and additional gestures let you move the focus on the screen and control the selected items.   It's better but not mandatory to **activate the vibration** feature in the accessibility settings in order to feel the trigger of some actions. &lt;/br&gt;&lt;img style=\&quot;max-width: 500px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iphonex_vo_en_vibration.png\&quot; /&gt; &lt;/br&gt;A sound may be heard in case of a disactivated vibration feature but VoiceOver might cover it.  Two gestures are important to be well understood so as to perfectly harness the provided details thereafter : &lt;/br&gt;&lt;img style=\&quot;max-width: 100px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iphonex_1finger_flick_up.png\&quot; /&gt; The **flick** consists in raising the finger of the screen at the end of the mopvement while continuing it in the air. &lt;/br&gt;&lt;img style=\&quot;max-width: 100px; height: auto;\&quot; alt=\&quot;\&quot; src=\&quot;./images/iphonex_1finger_swipe_up.png\&quot; /&gt; The **swipe** consists in doing the gesture while keeping the finger on the screen.  First, VoiceOver common gestures will be introduced to be followed by iPhoneX dedicated gestures. &lt;/br&gt;The last part will deal with unusual but useful features for an advanced user.  "
});
