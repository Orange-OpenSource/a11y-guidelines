...
index.add({
    url: "dev-ios.html#example",
    title: "Example",    
    body: "### Example An application with a tab bar, whose second bar item displays the Orange logo (added `Aspect Fit` content mode and constraints to stretch the image view), is created to test the features exposed in the description. &lt;/br&gt;&lt;/br&gt;With the `Larger Accessibility Sizes` activation in the settings (see &lt;a href=\&quot;https://a11y-guidelines.orange.com/mobile_EN/dev-ios.html#graphical-elements-size\&quot;&gt;the previous section&lt;/a&gt;), one can easily note in the application &amp;nbsp;: - A larger Orange image size. - A larger version of the bar item in an overlay if you touch and hold over it. &lt;/br&gt;&lt;img alt=\&quot;\&quot; style=\&quot;max-width: 1200px; height: auto; \&quot; src=\&quot;./images/iOSdev/TailleDesEltsGraphiques_10.png\&quot; /&gt; "
});
